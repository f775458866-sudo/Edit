...
.field private static v:LY2/i;


# instance fields
.field private final a:Lcom/google/common/collect/ImmutableMap;

.field private final b:LY2/d$a$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LY2/i;->p:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v0, LY2/i;->q:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v4, LY2/i;->r:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v4, LY2/i;->s:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v1, LY2/i;->t:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v0, LY2/i;->u:Lcom/google/common/collect/ImmutableList;

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;ILG2/c;Z)V
    .locals 0
    ...
    iput-object p2, p0, LY2/i;->a:Lcom/google/common/collect/ImmutableMap;

    .line 4
    new-instance p2, LY2/d$a$a;

    invoke-direct {p2}, LY2/d$a$a;-><init>()V

    iput-object p2, p0, LY2/i;->b:LY2/d$a$a;

    .line 5
    new-instance p2, LY2/q;

    invoke-direct {p2, p3}, LY2/q;-><init>(I)V

    iput-object p2, p0, LY2/i;->e:LY2/q;

    .line 6
    iput-object p4, p0, LY2/i;->c:LG2/c;
    ...
    .line 9
    invoke-virtual {p1}, LG2/u;->f()I

    move-result p2

    iput p2, p0, LY2/i;->m:I

    .line 10
    invoke-direct {p0, p2}, LY2/i;->m(I)J

    move-result-wide p2

    iput-wide p2, p0, LY2/i;->k:J

    .line 11
    new-instance p2, LY2/h;

    invoke-direct {p2, p0}, LY2/h;-><init>(LY2/i;)V

    invoke-virtual {p1, p2}, LG2/u;->h(LG2/u$c;)V
    ...
    .line 12
    iput p1, p0, LY2/i;->m:I

    .line 13
    invoke-direct {p0, p1}, LY2/i;->m(I)J

    move-result-wide p1

    iput-wide p1, p0, LY2/i;->k:J

    return-void
.end method

.method synthetic constructor <init>(Landroid/content/Context;Ljava/util/Map;ILG2/c;ZLY2/i$a;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p5}, LY2/i;-><init>(Landroid/content/Context;Ljava/util/Map;ILG2/c;Z)V

    return-void
.end method

.method public static synthetic j(LY2/i;I)V
    .locals 0

    invoke-direct {p0, p1}, LY2/i;->q(I)V
...
.method static synthetic k(Ljava/lang/String;)[I
    ...
    invoke-static {p0}, LY2/i;->l(Ljava/lang/String;)[I
...
.method private m(I)J
    ...
    iget-object v0, p0, LY2/i;->a:Lcom/google/common/collect/ImmutableMap;
    ...
    iget-object p1, p0, LY2/i;->a:Lcom/google/common/collect/ImmutableMap;
...
.method public static declared-synchronized n(Landroid/content/Context;)LY2/i;
    .locals 2
    ...
    invoke-direct {v1, p0}, LY2/i$b;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1}, LY2/i$b;->a()LY2/i;

    move-result-object p0

    sput-object p0, LY2/i;->v:LY2/i;
...
.method private static o(LI2/j;Z)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, LI2/j;->d(I)Z
...
.method private p(IJJ)V
    ...
    :cond_0
    iput-wide p4, p0, LY2/i;->l:J

    iget-object v1, p0, LY2/i;->b:LY2/d$a$a;
    ...
    invoke-virtual/range {v1 .. v6}, LY2/d$a$a;->c(IJJ)V
...
.method private declared-synchronized q(I)V
    ...
    iput-wide v0, p0, LY2/i;->k:J

    iget-object p1, p0, LY2/i;->c:LG2/c;

    invoke-interface {p1}, LG2/c;->elapsedRealtime()J

    move-result-wide v0

    iget p1, p0, LY2/i;->f:I
    :try_end_4
    ...
    :goto_1
    :try_start_6
    iget-wide v4, p0, LY2/i;->h:J

    iget-wide v6, p0, LY2/i;->k:J
    :try_end_6
    ...
    :try_start_7
    invoke-direct/range {v2 .. v7}, LY2/i;->p(IJJ)V

    iput-wide v0, v2, LY2/i;->g:J

    const-wide/16 v0, 0x0

    iput-wide v0, v2, LY2/i;->h:J

    iput-wide v0, v2, LY2/i;->j:J

    iput-wide v0, v2, LY2/i;->i:J

    iget-object p1, v2, LY2/i;->e:LY2/q;

    invoke-virtual {p1}, LY2/q;->g()V
    :try_end_7
...
# virtual methods
.method public b(Landroid/os/Handler;LY2/d$a;)V
    .locals 1
    ...
    iget-object v0, p0, LY2/i;->b:LY2/d$a$a;

    invoke-virtual {v0, p1, p2}, LY2/d$a$a;->b(Landroid/os/Handler;LY2/d$a;)V

    return-void
.end method

.method public c()LI2/x;
    .locals 0

    return-object p0
.end method

.method public d(LY2/d$a;)V
    .locals 1

    iget-object v0, p0, LY2/i;->b:LY2/d$a$a;

    invoke-virtual {v0, p1}, LY2/d$a$a;->d(LY2/d$a;)V
...
.method public f(LI2/f;LI2/j;Z)V
    .locals 0

    return-void
.end method

.method public declared-synchronized g(LI2/f;LI2/j;Z)V
    .locals 0

    monitor-enter p0

    :try_start_0
    invoke-static {p2, p3}, LY2/i;->o(LI2/j;Z)Z
...
.method public declared-synchronized h(LI2/f;LI2/j;Z)V
    .locals 10
    ...
    iput-wide v2, p0, LY2/i;->i:J

    iget-wide v2, p0, LY2/i;->j:J

    iget-wide v6, p0, LY2/i;->h:J

    add-long/2addr v2, v6

    iput-wide v2, p0, LY2/i;->j:J
    ...
    iget-object p3, p0, LY2/i;->e:LY2/q;
    ...
    invoke-virtual {p3, v2, p1}, LY2/q;->c(IF)V
    ...
    :goto_1
    :try_start_3
    iget-object p1, p0, LY2/i;->e:LY2/q;

    const/high16 p3, 0x3f000000    # 0.5f

    invoke-virtual {p1, p3}, LY2/q;->f(F)F

    move-result p1

    float-to-long v2, p1

    iput-wide v2, p0, LY2/i;->k:J

    :cond_3
    iget-wide v6, p0, LY2/i;->h:J

    iget-wide v8, p0, LY2/i;->k:J
    :try_end_3
    ...
    :try_start_4
    invoke-direct/range {v4 .. v9}, LY2/i;->p(IJJ)V

    iput-wide v0, v4, LY2/i;->g:J

    const-wide/16 v0, 0x0

    iput-wide v0, v4, LY2/i;->h:J
    ...
    :goto_3
    iget p1, v4, LY2/i;->f:I

    sub-int/2addr p1, p2

    iput p1, v4, LY2/i;->f:I
    :try_end_4
...
.method public declared-synchronized i(LI2/f;LI2/j;ZI)V
    .locals 0
    ...
    :cond_0
    :try_start_1
    iget-wide p1, p0, LY2/i;->h:J

    int-to-long p3, p4

    add-long/2addr p1, p3

    iput-wide p1, p0, LY2/i;->h:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
