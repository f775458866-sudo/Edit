...
# direct methods
.method private static final a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;IILD1/H;Lw1/J;LY0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    .locals 17
    ...
    invoke-interface {v1, v0}, LD1/H;->b(I)I
    ...
    invoke-virtual/range {p4 .. p4}, Lw1/J;->w()Lw1/j;

    move-result-object v7

    invoke-static {v4, v5}, Lw1/N;->b(II)J

    move-result-wide v8

    const/4 v5, 0x0

    invoke-virtual {v7, v8, v9, v6, v5}, Lw1/j;->a(J[FI)[F
    ...
    invoke-interface {v1, v11}, LD1/H;->b(I)I
    ...
    invoke-direct {v7, v8, v9, v10, v5}, LY0/i;-><init>(FFFF)V

    invoke-virtual {v3, v7}, LY0/i;->r(LY0/i;)Z

    move-result v5

    invoke-virtual {v7}, LY0/i;->i()F
    ...
    invoke-static {v3, v8, v9}, Ls0/o0;->c(LY0/i;FF)Z

    move-result v8

    if-eqz v8, :cond_1

    invoke-virtual {v7}, LY0/i;->j()F
    ...
    :goto_3
    invoke-virtual {v8, v2}, Lw1/J;->c(I)LI1/i;

    move-result-object v2

    sget-object v9, LI1/i;->d:LI1/i;
...
.method public static final b(Landroid/view/inputmethod/CursorAnchorInfo$Builder;LD1/P;LD1/H;Lw1/J;Landroid/graphics/Matrix;LY0/i;LY0/i;ZZZZ)Landroid/view/inputmethod/CursorAnchorInfo;
    .locals 6
    ...
    invoke-static {p0, p4, p2, p3, p5}, Ls0/o0;->d(Landroid/view/inputmethod/CursorAnchorInfo$Builder;ILD1/H;Lw1/J;LY0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static/range {v0 .. v5}, Ls0/o0;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;IILD1/H;Lw1/J;LY0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static {p0, p6}, Ls0/l;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;LY0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static {p0, p3, p5}, Ls0/n;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;Lw1/J;LY0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
...
.method public static final c(LY0/i;FF)Z
    .locals 2
...
.method private static final d(Landroid/view/inputmethod/CursorAnchorInfo$Builder;ILD1/H;Lw1/J;LY0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    .locals 9
    ...
    invoke-static {p4, v4, v0}, Ls0/o0;->c(LY0/i;FF)Z
    ...
    invoke-static {p4, v4, v1}, Ls0/o0;->c(LY0/i;FF)Z

    move-result p4

    invoke-virtual {p3, p1}, Lw1/J;->c(I)LI1/i;

    move-result-object p1

    sget-object p3, LI1/i;->d:LI1/i;
