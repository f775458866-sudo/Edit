...
# static fields
.field private static final a:Lx/p;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LA/Q;->a:Lx/p;

    return-void
.end method

.method public static a(Landroid/content/Context;LA/L;Lx/p;)V
    .locals 7
    ...
    invoke-static {p0}, LA/Q$a;->a(Landroid/content/Context;)I

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, LA/L;->a()Ljava/util/LinkedHashSet;
    ...
    :cond_0
    new-instance p0, LA/Q$b;

    const-string p1, "No cameras available"

    invoke-direct {p0, p1, v2, v3}, LA/Q$b;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    :try_start_0
    invoke-virtual {p2}, Lx/p;->d()Ljava/lang/Integer;
    ...
    invoke-static {v4, p0}, Lx/W;->l(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v4, p1, p0}, Lx/W;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_4
    :goto_0
    sget-object v5, Lx/p;->d:Lx/p;

    invoke-virtual {p1}, LA/L;->a()Ljava/util/LinkedHashSet;

    move-result-object v6

    invoke-virtual {v5, v6}, Lx/p;->e(Ljava/util/LinkedHashSet;)LA/H;
    :try_end_1
    ...
    invoke-static {v4, v1, v3}, Lx/W;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_6
    :goto_3
    sget-object p0, Lx/p;->c:Lx/p;

    invoke-virtual {p1}, LA/L;->a()Ljava/util/LinkedHashSet;

    move-result-object p2

    invoke-virtual {p0, p2}, Lx/p;->e(Ljava/util/LinkedHashSet;)LA/H;
    :try_end_2
    ...
    invoke-static {v4, p0, v3}, Lx/W;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_7
    :goto_5
    :try_start_3
    sget-object p0, LA/Q;->a:Lx/p;
    ...
    invoke-static {v4, p0}, Lx/W;->c(Ljava/lang/String;Ljava/lang/String;)V
