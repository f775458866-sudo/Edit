...
.method private static final b(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lx1/L;->a(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Rect;)V
...
.method public static final c(Landroid/text/TextPaint;Ljava/lang/CharSequence;II)Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, p2, p3}, Lx1/N;->b(Landroid/text/Spanned;Ljava/lang/Class;II)Z
    ...
    :cond_2
    invoke-static {v4, p1, p2, v5, v3}, Lx1/M;->b(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Rect;)V

    invoke-static {v2, v3}, Lx1/M;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    :cond_4
    :goto_2
    invoke-static {p0, p1, p2, p3}, Lx1/M;->d(Landroid/graphics/Paint;Ljava/lang/CharSequence;II)Landroid/graphics/Rect;
...
.method public static final d(Landroid/graphics/Paint;Ljava/lang/CharSequence;II)Landroid/graphics/Rect;
    ...
    invoke-static {p0, p1, p2, p3, v0}, Lx1/M;->b(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Rect;)V
