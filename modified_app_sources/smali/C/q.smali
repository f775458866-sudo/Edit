...
.method static constructor <clinit>()V
    ...
    sput-object v0, LC/q;->a:Landroid/graphics/RectF;
...
.method public static c(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    invoke-static {p0, p1, p2, v0}, LC/q;->d(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public static d(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
    ...
    :cond_0
    invoke-static {p1}, LC/q;->b(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static e(Landroid/graphics/Rect;I)Landroid/util/Size;
    ...
    invoke-static {p0}, LC/q;->l(Landroid/graphics/Rect;)Landroid/util/Size;

    move-result-object p0

    invoke-static {p0, p1}, LC/q;->o(Landroid/util/Size;I)Landroid/util/Size;
...
.method public static f(Landroid/graphics/Matrix;)I
    .locals 4
...
.method public static g(Landroid/graphics/Rect;Landroid/util/Size;)Z
    .locals 2
...
.method public static i(Landroid/util/Size;Landroid/util/Size;)Z
    ...
    invoke-static {p0, v0, p1, v0}, LC/q;->j(Landroid/util/Size;ZLandroid/util/Size;Z)Z
...
.method public static k(Landroid/graphics/Matrix;)Z
    ...
    invoke-static {v1, v3, v4, v0}, LC/q;->a(FFFF)F
...
.method public static o(Landroid/util/Size;I)Landroid/util/Size;
    ...
    invoke-static {p1}, LC/q;->h(I)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p0}, LC/q;->n(Landroid/util/Size;)Landroid/util/Size;
...
.method public static p(Landroid/util/Size;)Landroid/graphics/Rect;
    ...
    invoke-static {p0, v0, v0}, LC/q;->q(Landroid/util/Size;II)Landroid/graphics/Rect;
...
.method public static r(Landroid/util/Size;)Landroid/graphics/RectF;
    ...
    invoke-static {p0, v0, v0}, LC/q;->s(Landroid/util/Size;II)Landroid/graphics/RectF;
