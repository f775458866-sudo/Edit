...
.method static constructor <clinit>()V
    ...
    sput-object v0, LC/a;->a:Landroid/util/Rational;

    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v1}, Landroid/util/Rational;-><init>(II)V

    sput-object v0, LC/a;->b:Landroid/util/Rational;
    ...
    sput-object v0, LC/a;->c:Landroid/util/Rational;

    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v1}, Landroid/util/Rational;-><init>(II)V

    sput-object v0, LC/a;->d:Landroid/util/Rational;
...
.method public static a(Landroid/util/Size;Landroid/util/Rational;)Z
    ...
    sget-object v0, LJ/d;->c:Landroid/util/Size;

    invoke-static {p0, p1, v0}, LC/a;->b(Landroid/util/Size;Landroid/util/Rational;Landroid/util/Size;)Z
...
.method public static b(Landroid/util/Size;Landroid/util/Rational;Landroid/util/Size;)Z
    ...
    invoke-static {p0, p1}, LC/a;->c(Landroid/util/Size;Landroid/util/Rational;)Z
...
.method private static c(Landroid/util/Size;Landroid/util/Rational;)Z
    ...
    invoke-static {v2, v0, p1}, LC/a;->d(IILandroid/util/Rational;)Z
    ...
    invoke-static {p1, p0, v1}, LC/a;->d(IILandroid/util/Rational;)Z
    ...
    invoke-static {p0, v0, p1}, LC/a;->d(IILandroid/util/Rational;)Z
    ...
    invoke-static {v0, p0, v1}, LC/a;->d(IILandroid/util/Rational;)Z
