...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LM2/W;->a:Ljava/nio/ByteBuffer;
...
.method private b(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;
    ...
    :cond_0
    sget-object v3, LM2/W;->d:[B

    array-length v3, v3

    :goto_0
    sget-object v4, LM2/W;->e:[B
    ...
    :goto_1
    invoke-direct {p0, v2}, LM2/W;->c(I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p0, v2, v1}, LM2/W;->e(Ljava/nio/ByteBuffer;[B)V

    goto :goto_2

    :cond_2
    sget-object v1, LM2/W;->d:[B

    invoke-virtual {v2, v1}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    :goto_2
    sget-object v1, LM2/W;->e:[B

    invoke-virtual {v2, v1}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    :cond_3
    invoke-static {v7}, Lc3/H;->j(Ljava/nio/ByteBuffer;)I
    ...
    iget v4, p0, LM2/W;->b:I

    const/4 v6, 0x0

    move-object v0, p0

    invoke-direct/range {v0 .. v6}, LM2/W;->f(Ljava/nio/ByteBuffer;JIIZ)V
    ...
    invoke-static {v2, v4, v6, v12}, LG2/N;->w([BIII)I
    ...
    invoke-static {v2, v4, v5, v12}, LG2/N;->w([BIII)I
...
.method private c(I)Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, LM2/W;->a:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p0, LM2/W;->a:Ljava/nio/ByteBuffer;

    goto :goto_0

    :cond_0
    iget-object p1, p0, LM2/W;->a:Ljava/nio/ByteBuffer;
...
.method private e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p1, v0, v2, v3}, LG2/N;->w([BIII)I
...
# virtual methods
.method public a(LJ2/f;Ljava/util/List;)V
    .locals 2
    ...
    iget-object v1, p1, LJ2/f;->g:Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p0, v0, p2}, LM2/W;->b(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;

    move-result-object p2

    iput-object p2, p0, LM2/W;->a:Ljava/nio/ByteBuffer;

    invoke-virtual {p1}, LJ2/f;->f()V

    iget-object p2, p0, LM2/W;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object p2, p1, LJ2/f;->g:Ljava/nio/ByteBuffer;
