...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/J;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Lg/a;->colorButtonNormal:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/J;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/J;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/J;->e:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Landroidx/core/graphics/d;->g(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroidx/appcompat/widget/J;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/J;->i:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/J;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/J;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v2, Landroidx/appcompat/widget/J;->b:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/J;->f:[I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/J;->b(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v6

    sget-object v3, Landroidx/appcompat/widget/J;->f:[I

    aput-object v3, v1, v5

    sget v3, Lg/a;->colorControlActivated:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/J;->c(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/J;->i:[I
...
.method private l(Landroidx/appcompat/widget/F;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/F;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Lg/e;->abc_star_half_black_48dp:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/F;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
# virtual methods
.method public a(Landroidx/appcompat/widget/F;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/g$a;->l(Landroidx/appcompat/widget/F;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/J;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/J;->c(Landroid/content/Context;I)I
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/J;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/J;->b(Landroid/content/Context;I)I
