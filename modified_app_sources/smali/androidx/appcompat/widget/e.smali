...
.method d(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v3, p2, v8}, Landroidx/appcompat/widget/N;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/N;
    ...
    invoke-virtual {v9}, Landroidx/appcompat/widget/N;->r()Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v9, p1}, Landroidx/appcompat/widget/N;->s(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {v9, p1, v8}, Landroidx/appcompat/widget/N;->n(II)I
    ...
    invoke-virtual {v9, p1}, Landroidx/appcompat/widget/N;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, p1, v0}, Landroidx/appcompat/widget/N;->k(II)I
    ...
    :cond_3
    invoke-virtual {v9}, Landroidx/appcompat/widget/N;->x()V
