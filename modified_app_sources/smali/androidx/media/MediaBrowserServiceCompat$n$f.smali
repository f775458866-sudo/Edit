...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;ILjava/lang/String;ILandroid/os/Bundle;)V
    ...
    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->f:Ljava/lang/String;
...
.method public run()V
    ...
    iget v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->g:I
    ...
    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->j:Landroidx/media/MediaBrowserServiceCompat$n;

    iget-object v6, v3, Landroidx/media/MediaBrowserServiceCompat$n;->a:Landroidx/media/MediaBrowserServiceCompat;
    ...
    iget-object v10, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->i:Landroid/os/Bundle;
    ...
    iget-object v6, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->f:Ljava/lang/String;

    iget v7, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->g:I

    iget v8, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->d:I

    iget-object v9, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->i:Landroid/os/Bundle;
    ...
    invoke-virtual {v1, v0, v3}, Landroidx/collection/X;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
