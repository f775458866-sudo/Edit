...
.method private static a(Landroid/content/res/Resources;ILa2/i;I)I
    .locals 1
    ...
    :cond_2
    invoke-interface {p2}, La2/i;->get()Ljava/lang/Object;
...
.method private static c(Landroid/content/res/Resources;II)I
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/view/f0;->b(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;)I
...
.method public static e(Landroid/view/ViewConfiguration;Landroid/content/Context;)F
    ...
    invoke-static {p0}, Landroidx/core/view/f0$a;->a(Landroid/view/ViewConfiguration;)F
...
.method public static f(Landroid/content/Context;Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {p1, p2, p3, p4}, Landroidx/core/view/f0$c;->a(Landroid/view/ViewConfiguration;III)I
    ...
    :cond_0
    invoke-static {p2, p3, p4}, Landroidx/core/view/f0;->i(III)Z
    ...
    invoke-static {p0, p4, p3}, Landroidx/core/view/f0;->c(Landroid/content/res/Resources;II)I
    ...
    invoke-static {p0, p2, p3, v0}, Landroidx/core/view/f0;->a(Landroid/content/res/Resources;ILa2/i;I)I
...
.method public static g(Landroid/content/Context;Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {p1, p2, p3, p4}, Landroidx/core/view/f0$c;->b(Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {p0, p4, p3}, Landroidx/core/view/f0;->d(Landroid/content/res/Resources;II)I

    move-result p2

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance p3, Landroidx/core/view/e0;

    invoke-direct {p3, p1}, Landroidx/core/view/e0;-><init>(Landroid/view/ViewConfiguration;)V
...
.method public static h(Landroid/view/ViewConfiguration;Landroid/content/Context;)F
    ...
    invoke-static {p0}, Landroidx/core/view/f0$a;->b(Landroid/view/ViewConfiguration;)F
...
.method public static j(Landroid/view/ViewConfiguration;Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Landroidx/core/view/f0$b;->b(Landroid/view/ViewConfiguration;)Z
    ...
    invoke-static {p0, p1, v0}, Landroidx/core/view/f0;->b(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;)I
