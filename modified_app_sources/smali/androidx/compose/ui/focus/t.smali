...
# direct methods
.method public static final synthetic a(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)Z
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/focus/t;->i(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)Z
...
.method private static final b(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    .locals 9
    ...
    sget-object v1, Landroidx/compose/ui/focus/t$a;->a:[I
    ...
    invoke-static {p0, p1}, Landroidx/compose/ui/focus/t;->g(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-static {p0, v0, v1, p1}, Landroidx/compose/ui/focus/t;->d(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)Z
    ...
    :cond_8
    invoke-static {v0, p1}, Landroidx/compose/ui/focus/t;->b(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-virtual {v0}, Landroidx/compose/ui/focus/p;->p2()Landroidx/compose/ui/focus/h;
...
.method private static final c(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    .locals 3
    ...
    :cond_0
    invoke-static {p0, p1}, Landroidx/compose/ui/focus/t;->h(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-static {v0, p1}, Landroidx/compose/ui/focus/t;->c(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-static {p0, v0, v2, p1}, Landroidx/compose/ui/focus/t;->d(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)Z
...
.method private static final d(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)Z
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Landroidx/compose/ui/focus/t$b;-><init>(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)V
...
.method private static final e(Landroidx/compose/ui/focus/p;)Z
    .locals 10
    ...
    instance-of v7, v5, Landroidx/compose/ui/focus/p;
...
.method public static final f(Landroidx/compose/ui/focus/p;ILx6/l;)Z
    .locals 2
    ...
    invoke-static {p0, p2}, Landroidx/compose/ui/focus/t;->c(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-static {p0, p2}, Landroidx/compose/ui/focus/t;->b(Landroidx/compose/ui/focus/p;Lx6/l;)Z
...
.method private static final g(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    .locals 11
    ...
    :cond_b
    sget-object p0, Landroidx/compose/ui/focus/s;->c:Landroidx/compose/ui/focus/s;

    invoke-virtual {v0, p0}, LI0/b;->A(Ljava/util/Comparator;)V
    ...
    invoke-static {v1}, Landroidx/compose/ui/focus/r;->g(Landroidx/compose/ui/focus/p;)Z

    move-result v2

    if-eqz v2, :cond_d

    invoke-static {v1, p1}, Landroidx/compose/ui/focus/t;->b(Landroidx/compose/ui/focus/p;Lx6/l;)Z
...
.method private static final h(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    .locals 11
    ...
    invoke-static {v2}, Landroidx/compose/ui/focus/r;->g(Landroidx/compose/ui/focus/p;)Z

    move-result v4

    if-eqz v4, :cond_d

    invoke-static {v2, p1}, Landroidx/compose/ui/focus/t;->c(Landroidx/compose/ui/focus/p;Lx6/l;)Z
...
.method private static final i(Landroidx/compose/ui/focus/p;Landroidx/compose/ui/focus/p;ILx6/l;)Z
    .locals 12
    ...
    invoke-static {v4, v5}, Lp1/k;->a(LI0/b;Landroidx/compose/ui/e$c;)V
    ...
    invoke-virtual {v4, v5}, LI0/b;->v(I)Ljava/lang/Object;
    ...
    instance-of v9, v5, Landroidx/compose/ui/focus/p;

    if-eqz v9, :cond_3

    check-cast v5, Landroidx/compose/ui/focus/p;

    invoke-virtual {v0, v5}, LI0/b;->b(Ljava/lang/Object;)Z
    ...
    invoke-direct {v8, v11, v3}, LI0/b;-><init>([Ljava/lang/Object;I)V

    :cond_5
    if-eqz v5, :cond_6

    invoke-virtual {v8, v5}, LI0/b;->b(Ljava/lang/Object;)Z
    ...
    :cond_b
    sget-object v1, Landroidx/compose/ui/focus/s;->c:Landroidx/compose/ui/focus/s;
    ...
    invoke-direct {v1, v3, v2}, LD6/f;-><init>(II)V
    ...
    invoke-static {v5}, Landroidx/compose/ui/focus/r;->g(Landroidx/compose/ui/focus/p;)Z

    move-result v7

    if-eqz v7, :cond_c

    invoke-static {v5, p3}, Landroidx/compose/ui/focus/t;->c(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-static {v5, p3}, Landroidx/compose/ui/focus/t;->b(Landroidx/compose/ui/focus/p;Lx6/l;)Z
    ...
    invoke-interface {p1}, Landroidx/compose/ui/focus/h;->v()Z

    move-result p1

    if-eqz p1, :cond_13

    invoke-static {p0}, Landroidx/compose/ui/focus/t;->e(Landroidx/compose/ui/focus/p;)Z
