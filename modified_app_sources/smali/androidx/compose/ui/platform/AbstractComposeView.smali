...
.field private composition:LG0/q;

.field private creatingComposition:Z

.field private disposeViewCompositionStrategy:Lx6/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lx6/a;"
        }
...
.field private parentContext:LG0/r;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 7
    sget-object p1, Landroidx/compose/ui/platform/m1;->a:Landroidx/compose/ui/platform/m1$a;

    invoke-virtual {p1}, Landroidx/compose/ui/platform/m1$a;->a()Landroidx/compose/ui/platform/m1;

    move-result-object p1

    invoke-interface {p1, p0}, Landroidx/compose/ui/platform/m1;->a(Landroidx/compose/ui/platform/AbstractComposeView;)Lx6/a;

    move-result-object p1

    iput-object p1, p0, Landroidx/compose/ui/platform/AbstractComposeView;->disposeViewCompositionStrategy:Lx6/a;
...
.method private final a(LG0/r;)LG0/r;
    .locals 2

    invoke-direct {p0, p1}, Landroidx/compose/ui/platform/AbstractComposeView;->d(LG0/r;)Z
...
.method private final c()V
    ...
    iget-object v0, p0, Landroidx/compose/ui/platform/AbstractComposeView;->composition:LG0/q;
    ...
    invoke-direct {p0}, Landroidx/compose/ui/platform/AbstractComposeView;->e()LG0/r;
    ...
    invoke-static {v4, v1, v3}, LO0/c;->c(IZLjava/lang/Object;)LO0/a;

    move-result-object v1

    invoke-static {p0, v2, v1}, Landroidx/compose/ui/platform/C1;->c(Landroidx/compose/ui/platform/AbstractComposeView;LG0/r;Lx6/p;)LG0/q;

    move-result-object v1

    iput-object v1, p0, Landroidx/compose/ui/platform/AbstractComposeView;->composition:LG0/q;
    :try_end_0
...
.method private final d(LG0/r;)Z
    .locals 1

    instance-of v0, p1, LG0/L0;

    if-eqz v0, :cond_1

    check-cast p1, LG0/L0;

    invoke-virtual {p1}, LG0/L0;->d0()LL6/J;

    move-result-object p1

    invoke-interface {p1}, LL6/J;->getValue()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, LG0/L0$d;

    sget-object v0, LG0/L0$d;->d:LG0/L0$d;
...
.method private final e()LG0/r;
    .locals 3

    iget-object v0, p0, Landroidx/compose/ui/platform/AbstractComposeView;->parentContext:LG0/r;

    if-nez v0, :cond_3

    invoke-static {p0}, Landroidx/compose/ui/platform/z1;->d(Landroid/view/View;)LG0/r;
    ...
    invoke-direct {p0, v0}, Landroidx/compose/ui/platform/AbstractComposeView;->a(LG0/r;)LG0/r;
    ...
    invoke-direct {p0, v0}, Landroidx/compose/ui/platform/AbstractComposeView;->d(LG0/r;)Z
    ...
    invoke-static {p0}, Landroidx/compose/ui/platform/z1;->h(Landroid/view/View;)LG0/L0;
...
.method private final setParentContext(LG0/r;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/compose/ui/platform/AbstractComposeView;->parentContext:LG0/r;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/compose/ui/platform/AbstractComposeView;->composition:LG0/q;

    if-eqz p1, :cond_1

    invoke-interface {p1}, LG0/q;->a()V

    iput-object v0, p0, Landroidx/compose/ui/platform/AbstractComposeView;->composition:LG0/q;
...
# virtual methods
.method public abstract Content(LG0/m;I)V
.end method
...
.method public final setParentCompositionContext(LG0/r;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/compose/ui/platform/AbstractComposeView;->setParentContext(LG0/r;)V
...
.method public final setShowLayoutBounds(Z)V
    ...
    invoke-interface {v0, p1}, Lp1/m0;->setShowLayoutBounds(Z)V
...
.method public final setViewCompositionStrategy(Landroidx/compose/ui/platform/m1;)V
    .locals 1

    iget-object v0, p0, Landroidx/compose/ui/platform/AbstractComposeView;->disposeViewCompositionStrategy:Lx6/a;
