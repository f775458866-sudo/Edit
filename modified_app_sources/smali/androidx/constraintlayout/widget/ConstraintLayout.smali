...
.field protected mLayoutWidget:LQ1/f;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;
...
.method private a(I)LQ1/e;
    .locals 1

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->v0:LQ1/e;

    return-object p1
.end method

.method static synthetic access$000(Landroidx/constraintlayout/widget/ConstraintLayout;)LN1/e;
    .locals 0
...
.method private b(Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {v0, p0}, LQ1/e;->G0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, LQ1/f;->b2(LR1/b$b;)V
    ...
    invoke-virtual {v3, v4, v2}, Landroidx/constraintlayout/widget/c;->C(Landroid/content/Context;I)V
    :try_end_1
    ...
    invoke-virtual {p1, p2}, LQ1/f;->c2(I)V
...
.method private d()V
    ...
    invoke-virtual {p0, v3}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)LQ1/e;
    ...
    invoke-direct {p0, v4}, Landroidx/constraintlayout/widget/ConstraintLayout;->a(I)LQ1/e;

    move-result-object v4

    invoke-virtual {v4, v5}, LQ1/e;->H0(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v3}, Landroidx/constraintlayout/widget/Constraints;->getConstraintSet()Landroidx/constraintlayout/widget/c;
    ...
    invoke-virtual {v2, p0, v3}, Landroidx/constraintlayout/widget/c;->k(Landroidx/constraintlayout/widget/ConstraintLayout;Z)V

    :cond_6
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;

    invoke-virtual {v2}, LQ1/n;->z1()V
    ...
    invoke-virtual {v4, p0}, Landroidx/constraintlayout/widget/ConstraintHelper;->v(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    iget-object v3, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;
    ...
    invoke-virtual {p0, v2}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)LQ1/e;
    ...
    invoke-virtual {v0, v3}, LQ1/n;->b(LQ1/e;)V

    iget-object v5, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mTempMapIdToWidget:Landroid/util/SparseArray;

    move-object v0, p0

    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->applyConstraintsFromLayoutParams(ZLandroid/view/View;LQ1/e;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;)V
...
.method private e(LQ1/e;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;ILQ1/d$a;)V
    .locals 2
    ...
    iget-object v0, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->v0:LQ1/e;

    invoke-virtual {v0, p4}, LQ1/e;->P0(Z)V

    :cond_0
    invoke-virtual {p1, v1}, LQ1/e;->q(LQ1/d$a;)LQ1/d;

    move-result-object v0

    invoke-virtual {p3, p5}, LQ1/e;->q(LQ1/d$a;)LQ1/d;
    ...
    invoke-virtual {v0, p3, p5, p2, p4}, LQ1/d;->b(LQ1/d;IIZ)Z

    invoke-virtual {p1, p4}, LQ1/e;->P0(Z)V

    sget-object p2, LQ1/d$a;->f:LQ1/d$a;

    invoke-virtual {p1, p2}, LQ1/e;->q(LQ1/d$a;)LQ1/d;

    move-result-object p2

    invoke-virtual {p2}, LQ1/d;->q()V
...
# virtual methods
.method public addValueModifier(Landroidx/constraintlayout/widget/ConstraintLayout$c;)V
    .locals 1
...
.method protected applyConstraintsFromLayoutParams(ZLandroid/view/View;LQ1/e;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;)V
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-boolean v8, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->w0:Z

    invoke-virtual {v0}, Landroid/view/View;->getVisibility()I

    move-result v2

    invoke-virtual {v1, v2}, LQ1/e;->o1(I)V

    iget-boolean v2, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->j0:Z

    if-eqz v2, :cond_0

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, LQ1/e;->Y0(Z)V
    ...
    :cond_0
    invoke-virtual {v1, v0}, LQ1/e;->G0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2}, LQ1/f;->V1()Z

    move-result v2

    invoke-virtual {v0, v1, v2}, Landroidx/constraintlayout/widget/ConstraintHelper;->q(LQ1/e;Z)V

    :cond_1
    iget-boolean v0, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->h0:Z
    ...
    iget v0, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->s0:I

    iget v1, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->t0:I

    iget v2, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->u0:F
    ...
    invoke-virtual {p1, v2}, LQ1/h;->E1(F)V
    ...
    invoke-virtual {p1, v0}, LQ1/h;->C1(I)V
    ...
    invoke-virtual {p1, v1}, LQ1/h;->D1(I)V

    :cond_4
    return-void

    :cond_5
    iget v0, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->l0:I

    iget v2, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->m0:I

    iget v10, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->n0:I

    iget v11, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->o0:I

    iget v5, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->p0:I

    iget v12, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->q0:I

    iget v13, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->r0:F
    ...
    iget v2, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->r:F

    iget v3, v6, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->q:I

    invoke-virtual {v1, v0, v2, v3}, LQ1/e;->m(LQ1/e;FI)V
    ...
    sget-object v1, LQ1/d$a;->f:LQ1/d$a;
    ...
    sget-object v3, LQ1/d$a;->i:LQ1/d$a;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->e(LQ1/e;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;ILQ1/d$a;)V
    ...
    invoke-virtual {v0, v13}, LQ1/e;->R0(F)V
    ...
    invoke-virtual {v0, v3}, LQ1/e;->i1(F)V

    :cond_14
    :goto_6
    if-eqz p1, :cond_16

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->X:I

    if-ne p1, v9, :cond_15

    iget v1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->Y:I
    ...
    invoke-virtual {v0, p1, v1}, LQ1/e;->g1(II)V
    ...
    sget-object p1, LQ1/e$b;->f:LQ1/e$b;

    invoke-virtual {v0, p1}, LQ1/e;->U0(LQ1/e$b;)V

    goto :goto_7

    :cond_17
    sget-object p1, LQ1/e$b;->g:LQ1/e$b;
    ...
    invoke-virtual {v0, p1}, LQ1/e;->q(LQ1/d$a;)LQ1/d;

    move-result-object p1

    iget v3, v2, Landroid/view/ViewGroup$MarginLayoutParams;->leftMargin:I

    iput v3, p1, LQ1/d;->g:I
    ...
    invoke-virtual {v0, v8}, LQ1/e;->p1(I)V

    goto :goto_8

    :cond_19
    sget-object p1, LQ1/e$b;->c:LQ1/e$b;

    invoke-virtual {v0, p1}, LQ1/e;->U0(LQ1/e$b;)V

    iget p1, v2, Landroid/view/ViewGroup$MarginLayoutParams;->width:I

    invoke-virtual {v0, p1}, LQ1/e;->p1(I)V
    ...
    :cond_1a
    :goto_8
    iget-boolean p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->f0:Z
    ...
    iget-boolean p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->b0:Z

    if-eqz p1, :cond_1b

    sget-object p1, LQ1/e$b;->f:LQ1/e$b;

    invoke-virtual {v0, p1}, LQ1/e;->l1(LQ1/e$b;)V
    ...
    invoke-virtual {v0, v8}, LQ1/e;->Q0(I)V
    ...
    invoke-virtual {v0, p1}, LQ1/e;->Q0(I)V
    ...
    :cond_1e
    :goto_a
    iget-object p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->I:Ljava/lang/String;

    invoke-virtual {v0, p1}, LQ1/e;->I0(Ljava/lang/String;)V

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->L:F

    invoke-virtual {v0, p1}, LQ1/e;->W0(F)V

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->M:F

    invoke-virtual {v0, p1}, LQ1/e;->n1(F)V

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->N:I

    invoke-virtual {v0, p1}, LQ1/e;->S0(I)V

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->O:I

    invoke-virtual {v0, p1}, LQ1/e;->j1(I)V

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->d0:I

    invoke-virtual {v0, p1}, LQ1/e;->q1(I)V
    ...
    iget v4, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->V:F

    invoke-virtual {v0, p1, v1, v3, v4}, LQ1/e;->V0(IIIF)V

    iget p1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->Q:I

    iget v1, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->S:I

    iget v3, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->U:I

    iget v2, v2, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->W:F

    invoke-virtual {v0, p1, v1, v3, v2}, LQ1/e;->m1(IIIF)V
...
.method protected dynamicUpdateConstraints(II)Z
    ...
    invoke-virtual {v2}, LQ1/n;->w1()Ljava/util/ArrayList;
...
.method public fillMetrics(LN1/e;)V
    .locals 1

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;

    invoke-virtual {v0, p1}, LQ1/f;->N1(LN1/e;)V
...
.method public getSceneString()Ljava/lang/String;
    ...
    iget-object v1, v1, LQ1/e;->o:Ljava/lang/String;
    ...
    iput-object v1, v3, LQ1/e;->o:Ljava/lang/String;
    ...
    iput-object v3, v1, LQ1/e;->o:Ljava/lang/String;
    ...
    iget-object v5, v1, LQ1/e;->o:Ljava/lang/String;

    invoke-virtual {v1, v5}, LQ1/e;->H0(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;

    invoke-virtual {v5}, LQ1/e;->v()Ljava/lang/String;
    ...
    invoke-virtual {v1}, LQ1/n;->w1()Ljava/util/ArrayList;
    ...
    invoke-virtual {v7}, LQ1/e;->u()Ljava/lang/Object;
    ...
    iget-object v9, v7, LQ1/e;->o:Ljava/lang/String;
    ...
    iput-object v8, v7, LQ1/e;->o:Ljava/lang/String;

    :cond_4
    invoke-virtual {v7}, LQ1/e;->v()Ljava/lang/String;

    move-result-object v8

    if-nez v8, :cond_3

    iget-object v8, v7, LQ1/e;->o:Ljava/lang/String;

    invoke-virtual {v7, v8}, LQ1/e;->H0(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, LQ1/f;->Q(Ljava/lang/StringBuilder;)V
...
.method public final getViewWidget(Landroid/view/View;)LQ1/e;
    .locals 1
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->v0:LQ1/e;
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v0, v2}, LQ1/f;->e2(Z)V
    ...
    invoke-direct {p0}, Landroidx/constraintlayout/widget/ConstraintLayout;->f()Z
    ...
    invoke-virtual {v0, v1}, LQ1/f;->N1(LN1/e;)V

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:LQ1/f;

    iget v1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mOptimizationLevel:I

    invoke-virtual {p0, v0, v1, p1, p2}, Landroidx/constraintlayout/widget/ConstraintLayout;->resolveSystem(LQ1/f;III)V
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)LQ1/e;
    ...
    iput-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->v0:LQ1/e;
    ...
    invoke-virtual {v1, v0}, LQ1/h;->F1(I)V
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, LQ1/n;->y1(LQ1/e;)V
...
.method removeValueModifier(Landroidx/constraintlayout/widget/ConstraintLayout$c;)V
    .locals 1
...
.method protected resolveSystem(LQ1/f;III)V
    .locals 13
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->setSelfDimensionBehaviour(LQ1/f;IIII)V
    ...
    invoke-virtual/range {v0 .. v9}, LQ1/f;->X1(IIIIIIIII)J
...
.method public setOptimizationLevel(I)V
    ...
    invoke-virtual {v0, p1}, LQ1/f;->c2(I)V

    return-void
.end method

.method protected setSelfDimensionBehaviour(LQ1/f;IIII)V
    .locals 7
    ...
    :cond_a
    invoke-virtual {p1}, LQ1/f;->T1()V

    :cond_b
    invoke-virtual {p1, v5}, LQ1/e;->r1(I)V

    invoke-virtual {p1, v5}, LQ1/e;->s1(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mMaxWidth:I

    sub-int/2addr p4, v0

    invoke-virtual {p1, p4}, LQ1/e;->c1(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mMaxHeight:I

    sub-int/2addr p4, v1

    invoke-virtual {p1, p4}, LQ1/e;->b1(I)V

    invoke-virtual {p1, v5}, LQ1/e;->f1(I)V

    invoke-virtual {p1, v5}, LQ1/e;->e1(I)V

    invoke-virtual {p1, p2}, LQ1/e;->U0(LQ1/e$b;)V

    invoke-virtual {p1, p3}, LQ1/e;->p1(I)V
    ...
    invoke-virtual {p1, p2}, LQ1/e;->e1(I)V
