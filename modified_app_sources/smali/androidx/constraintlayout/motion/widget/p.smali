...
.field final r:Landroidx/constraintlayout/motion/widget/t;
...
.method constructor <init>(Landroid/content/Context;Landroidx/constraintlayout/motion/widget/MotionLayout;I)V
    ...
    iput-boolean v1, p0, Landroidx/constraintlayout/motion/widget/p;->n:Z
    ...
    iput-object v0, p0, Landroidx/constraintlayout/motion/widget/p;->r:Landroidx/constraintlayout/motion/widget/t;
...
.method private J()Z
    ...
    iget-object v0, p0, Landroidx/constraintlayout/motion/widget/p;->p:Landroidx/constraintlayout/motion/widget/MotionLayout$g;
...
.method private K(Landroid/content/Context;I)V
    ...
    invoke-direct {v3, p1, v2}, Landroidx/constraintlayout/motion/widget/s;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v5, p0, Landroidx/constraintlayout/motion/widget/p;->r:Landroidx/constraintlayout/motion/widget/t;

    invoke-virtual {v5, v3}, Landroidx/constraintlayout/motion/widget/t;->a(Landroidx/constraintlayout/motion/widget/s;)V
    ...
    invoke-static {v4}, Landroidx/constraintlayout/motion/widget/p$b;->f(Landroidx/constraintlayout/motion/widget/p$b;)Ljava/util/ArrayList;
    ...
    :pswitch_2
    invoke-direct {p0, p1, v2}, Landroidx/constraintlayout/motion/widget/p;->N(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    goto/16 :goto_4

    :pswitch_3
    invoke-direct {p0, p1, v2}, Landroidx/constraintlayout/motion/widget/p;->L(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)I
    ...
    iput-object v3, p0, Landroidx/constraintlayout/motion/widget/p;->b:Landroidx/constraintlayout/widget/h;
    ...
    invoke-virtual {v4, p1, v2}, Landroidx/constraintlayout/motion/widget/p$b;->u(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v5, p0, Landroidx/constraintlayout/motion/widget/p;->a:Landroidx/constraintlayout/motion/widget/MotionLayout;

    invoke-direct {v3, p1, v5, v2}, Landroidx/constraintlayout/motion/widget/q;-><init>(Landroid/content/Context;Landroidx/constraintlayout/motion/widget/MotionLayout;Lorg/xmlpull/v1/XmlPullParser;)V

    invoke-static {v4, v3}, Landroidx/constraintlayout/motion/widget/p$b;->n(Landroidx/constraintlayout/motion/widget/p$b;Landroidx/constraintlayout/motion/widget/q;)Landroidx/constraintlayout/motion/widget/q;
    ...
    new-instance v4, Landroidx/constraintlayout/motion/widget/p$b;

    invoke-direct {v4, p0, p1, v2}, Landroidx/constraintlayout/motion/widget/p$b;-><init>(Landroidx/constraintlayout/motion/widget/p;Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {v4}, Landroidx/constraintlayout/motion/widget/p$b;->e(Landroidx/constraintlayout/motion/widget/p$b;)Z
    ...
    invoke-static {v3}, Landroidx/constraintlayout/motion/widget/p$b;->l(Landroidx/constraintlayout/motion/widget/p$b;)Landroidx/constraintlayout/motion/widget/q;

    move-result-object v3

    iget-boolean v5, p0, Landroidx/constraintlayout/motion/widget/p;->q:Z

    invoke-virtual {v3, v5}, Landroidx/constraintlayout/motion/widget/q;->x(Z)V
    ...
    iput-object v4, p0, Landroidx/constraintlayout/motion/widget/p;->f:Landroidx/constraintlayout/motion/widget/p$b;
    ...
    :pswitch_8
    invoke-direct {p0, p1, v2}, Landroidx/constraintlayout/motion/widget/p;->O(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private L(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)I
    ...
    :pswitch_0
    invoke-virtual {v0, v9}, Landroidx/constraintlayout/widget/c;->R(Ljava/lang/String;)V
    ...
    iput v8, v0, Landroidx/constraintlayout/widget/c;->e:I
    :try_end_0
    ...
    :pswitch_3
    iput v11, v0, Landroidx/constraintlayout/widget/c;->e:I

    goto :goto_5

    :pswitch_4
    iput v7, v0, Landroidx/constraintlayout/widget/c;->e:I

    goto :goto_5

    :pswitch_5
    iput v1, v0, Landroidx/constraintlayout/widget/c;->e:I

    goto :goto_5

    :pswitch_6
    iput v12, v0, Landroidx/constraintlayout/widget/c;->e:I

    goto :goto_5

    :pswitch_7
    iput v10, v0, Landroidx/constraintlayout/widget/c;->e:I
...
.method public G(I)Landroidx/constraintlayout/motion/widget/p$b;
    ...
    check-cast v3, Landroidx/constraintlayout/motion/widget/p$b;

    invoke-static {v3}, Landroidx/constraintlayout/motion/widget/p$b;->o(Landroidx/constraintlayout/motion/widget/p$b;)I
...
.method R(Landroid/view/MotionEvent;ILandroidx/constraintlayout/motion/widget/MotionLayout;)V
    ...
    iget-object v1, p0, Landroidx/constraintlayout/motion/widget/p;->p:Landroidx/constraintlayout/motion/widget/MotionLayout$g;

    if-nez v1, :cond_0

    iget-object v1, p0, Landroidx/constraintlayout/motion/widget/p;->a:Landroidx/constraintlayout/motion/widget/MotionLayout;

    invoke-virtual {v1}, Landroidx/constraintlayout/motion/widget/MotionLayout;->Z()Landroidx/constraintlayout/motion/widget/MotionLayout$g;

    move-result-object v1

    iput-object v1, p0, Landroidx/constraintlayout/motion/widget/p;->p:Landroidx/constraintlayout/motion/widget/MotionLayout$g;
    ...
    :cond_1
    iget-boolean v4, p0, Landroidx/constraintlayout/motion/widget/p;->n:Z
    ...
    iget v7, p0, Landroidx/constraintlayout/motion/widget/p;->s:F
    ...
    :cond_3
    iget-object v7, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;
    ...
    iget-object v4, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;

    invoke-virtual {v4}, Landroid/view/MotionEvent;->getX()F

    move-result v4

    iget-object v6, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;
    ...
    iget v4, p0, Landroidx/constraintlayout/motion/widget/p;->s:F
    ...
    iput-object p1, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;

    iput-boolean v5, p0, Landroidx/constraintlayout/motion/widget/p;->n:Z
    ...
    iget-object p2, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;

    invoke-virtual {p2}, Landroid/view/MotionEvent;->getX()F

    move-result p2

    iget-object p3, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;
    ...
    iput-object v1, p0, Landroidx/constraintlayout/motion/widget/p;->m:Landroid/view/MotionEvent;

    iput-boolean v3, p0, Landroidx/constraintlayout/motion/widget/p;->n:Z
    ...
    iget p2, p0, Landroidx/constraintlayout/motion/widget/p;->s:F

    iget p3, p0, Landroidx/constraintlayout/motion/widget/p;->t:F
    ...
    iget-object v4, p0, Landroidx/constraintlayout/motion/widget/p;->p:Landroidx/constraintlayout/motion/widget/MotionLayout$g;
    ...
    iget-object p1, p0, Landroidx/constraintlayout/motion/widget/p;->p:Landroidx/constraintlayout/motion/widget/MotionLayout$g;
...
.method public W(Z)V
    ...
    iput-boolean p1, p0, Landroidx/constraintlayout/motion/widget/p;->q:Z
    ...
    iget-boolean v0, p0, Landroidx/constraintlayout/motion/widget/p;->q:Z
...
.method X(II)V
    ...
    check-cast v7, Landroidx/constraintlayout/motion/widget/p$b;

    invoke-static {v7}, Landroidx/constraintlayout/motion/widget/p$b;->a(Landroidx/constraintlayout/motion/widget/p$b;)I

    move-result v8

    if-ne v8, v2, :cond_5

    invoke-static {v7}, Landroidx/constraintlayout/motion/widget/p$b;->c(Landroidx/constraintlayout/motion/widget/p$b;)I
    ...
    :cond_6
    iput-object v7, p0, Landroidx/constraintlayout/motion/widget/p;->c:Landroidx/constraintlayout/motion/widget/p$b;

    if-eqz v7, :cond_7

    invoke-static {v7}, Landroidx/constraintlayout/motion/widget/p$b;->l(Landroidx/constraintlayout/motion/widget/p$b;)Landroidx/constraintlayout/motion/widget/q;
    ...
    iget-boolean p2, p0, Landroidx/constraintlayout/motion/widget/p;->q:Z
    ...
    invoke-static {v6}, Landroidx/constraintlayout/motion/widget/p$b;->a(Landroidx/constraintlayout/motion/widget/p$b;)I
...
.method b0()Z
    ...
    check-cast v5, Landroidx/constraintlayout/motion/widget/p$b;

    invoke-static {v5}, Landroidx/constraintlayout/motion/widget/p$b;->l(Landroidx/constraintlayout/motion/widget/p$b;)Landroidx/constraintlayout/motion/widget/q;
...
.method public varargs c0(I[Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroidx/constraintlayout/motion/widget/p;->r:Landroidx/constraintlayout/motion/widget/t;
...
.method public f(Landroidx/constraintlayout/motion/widget/MotionLayout;I)V
    ...
    invoke-static {v4}, Landroidx/constraintlayout/motion/widget/p$b;->p(Landroidx/constraintlayout/motion/widget/p$b;)Ljava/util/ArrayList;
    ...
    check-cast v7, Landroidx/constraintlayout/motion/widget/p$b$a;

    invoke-virtual {v7, p1}, Landroidx/constraintlayout/motion/widget/p$b$a;->c(Landroidx/constraintlayout/motion/widget/MotionLayout;)V
    ...
    check-cast v8, Landroidx/constraintlayout/motion/widget/p$b$a;

    invoke-virtual {v8, p1, p2, v4}, Landroidx/constraintlayout/motion/widget/p$b$a;->a(Landroidx/constraintlayout/motion/widget/MotionLayout;ILandroidx/constraintlayout/motion/widget/p$b;)V
...
.method h(Landroidx/constraintlayout/motion/widget/MotionLayout;I)Z
    ...
    invoke-static {v4}, Landroidx/constraintlayout/motion/widget/p$b;->r(Landroidx/constraintlayout/motion/widget/p$b;)I
    ...
    :cond_3
    iget-object v5, p0, Landroidx/constraintlayout/motion/widget/p;->c:Landroidx/constraintlayout/motion/widget/p$b;

    const/4 v6, 0x2

    if-ne v5, v4, :cond_4

    invoke-virtual {v5, v6}, Landroidx/constraintlayout/motion/widget/p$b;->D(I)Z
    ...
    :cond_5
    sget-object p2, Landroidx/constraintlayout/motion/widget/MotionLayout$k;->g:Landroidx/constraintlayout/motion/widget/MotionLayout$k;
    ...
    invoke-virtual {p1, v4}, Landroidx/constraintlayout/motion/widget/MotionLayout;->setTransition(Landroidx/constraintlayout/motion/widget/p$b;)V
    ...
    sget-object p2, Landroidx/constraintlayout/motion/widget/MotionLayout$k;->f:Landroidx/constraintlayout/motion/widget/MotionLayout$k;
    ...
    invoke-virtual {p1, v7}, Landroidx/constraintlayout/motion/widget/MotionLayout;->L(Z)V
...
.method public s()Landroid/view/animation/Interpolator;
    ...
    invoke-static {v0}, LO1/c;->c(Ljava/lang/String;)LO1/c;

    move-result-object v0

    new-instance v1, Landroidx/constraintlayout/motion/widget/p$a;

    invoke-direct {v1, p0, v0}, Landroidx/constraintlayout/motion/widget/p$a;-><init>(Landroidx/constraintlayout/motion/widget/p;LO1/c;)V
...
.method public t(Landroidx/constraintlayout/motion/widget/m;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/constraintlayout/motion/widget/g;->b(Landroidx/constraintlayout/motion/widget/m;)V
