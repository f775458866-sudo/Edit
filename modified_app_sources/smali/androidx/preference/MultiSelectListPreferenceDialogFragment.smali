...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->q:Ljava/util/Set;
...
.method public e(Z)V
    ...
    iget-boolean p1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->x:Z

    if-eqz p1, :cond_0

    iget-object p1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->q:Ljava/util/Set;
    ...
    invoke-virtual {v0, p1}, Landroidx/preference/MultiSelectListPreference;->T0(Ljava/util/Set;)V

    :cond_0
    const/4 p1, 0x0

    iput-boolean p1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->x:Z
...
.method protected f(Landroid/app/AlertDialog$Builder;)V
    ...
    iget-object v0, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->z:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->q:Ljava/util/Set;

    iget-object v4, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->z:[Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->y:[Ljava/lang/CharSequence;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->q:Ljava/util/Set;
    ...
    iput-boolean v0, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->x:Z

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->Q0()[Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->y:[Ljava/lang/CharSequence;

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->R0()[Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->z:[Ljava/lang/CharSequence;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->x:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "MultiSelectListPreferenceDialogFragment.entries"

    iget-object v1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->y:[Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putCharSequenceArray(Ljava/lang/String;[Ljava/lang/CharSequence;)V

    const-string v0, "MultiSelectListPreferenceDialogFragment.entryValues"

    iget-object v1, p0, Landroidx/preference/MultiSelectListPreferenceDialogFragment;->z:[Ljava/lang/CharSequence;
