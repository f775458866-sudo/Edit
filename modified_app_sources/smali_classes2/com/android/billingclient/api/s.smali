...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/billingclient/api/s$c;,
        Lcom/android/billingclient/api/s$d;
    }
.end annotation
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/billingclient/api/s;->i:Ljava/lang/String;
    ...
    new-instance v4, Lcom/android/billingclient/api/s$e;

    invoke-virtual {p1, v3}, Lorg/json/JSONArray;->getJSONObject(I)Lorg/json/JSONObject;

    move-result-object v5

    invoke-direct {v4, v5}, Lcom/android/billingclient/api/s$e;-><init>(Lorg/json/JSONObject;)V
    ...
    :cond_0
    iput-object v1, p0, Lcom/android/billingclient/api/s;->j:Ljava/util/List;
    ...
    :goto_2
    iput-object p1, p0, Lcom/android/billingclient/api/s;->j:Ljava/util/List;
    ...
    new-instance p1, Lcom/android/billingclient/api/s$b;

    invoke-virtual {v1, v2}, Lorg/json/JSONArray;->getJSONObject(I)Lorg/json/JSONObject;

    move-result-object v0

    invoke-direct {p1, v0}, Lcom/android/billingclient/api/s$b;-><init>(Lorg/json/JSONObject;)V
    ...
    :cond_4
    iput-object v3, p0, Lcom/android/billingclient/api/s;->k:Ljava/util/List;
    ...
    invoke-direct {v0, p1}, Lcom/android/billingclient/api/s$b;-><init>(Lorg/json/JSONObject;)V
    ...
    :cond_6
    iput-object v0, p0, Lcom/android/billingclient/api/s;->k:Ljava/util/List;
...
.method public a()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/s;->g:Ljava/lang/String;
...
.method public b()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/s;->f:Ljava/lang/String;

    return-object v0
.end method

.method public c()Lcom/android/billingclient/api/s$b;
    .locals 2

    iget-object v0, p0, Lcom/android/billingclient/api/s;->k:Ljava/util/List;
...
.method public f()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/s;->j:Ljava/util/List;
...
.method final i()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/s;->h:Ljava/lang/String;
...
.method public j()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/s;->i:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/billingclient/api/s;->a:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/billingclient/api/s;->c:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/billingclient/api/s;->d:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/billingclient/api/s;->e:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/billingclient/api/s;->h:Ljava/lang/String;
