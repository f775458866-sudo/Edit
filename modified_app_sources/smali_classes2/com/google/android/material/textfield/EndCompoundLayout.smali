...
.field private touchExplorationStateChangeListener:Lb2/c$a;


# direct methods
.method constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/N;)V
    .locals 6
    ...
    invoke-direct {v4, p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout$EndIconDelegates;-><init>(Lcom/google/android/material/textfield/EndCompoundLayout;Landroidx/appcompat/widget/N;)V
    ...
    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initErrorIconView(Landroidx/appcompat/widget/N;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initEndIconView(Landroidx/appcompat/widget/N;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initSuffixTextView(Landroidx/appcompat/widget/N;)V
...
.method private addTouchExplorationStateChangeListenerIfNeeded()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lb2/c$a;
    ...
    invoke-static {p0}, Landroidx/core/view/b0;->R(Landroid/view/View;)Z
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lb2/c$a;

    invoke-static {v0, v1}, Lb2/c;->a(Landroid/view/accessibility/AccessibilityManager;Lb2/c$a;)Z
...
.method private initEndIconView(Landroidx/appcompat/widget/N;)V
    .locals 6
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/widget/N;->s(I)Z
    ...
    invoke-static {v4, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/N;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v1, v3}, Landroidx/appcompat/widget/N;->k(II)I
    ...
    invoke-virtual {p1, v1, v5}, Landroidx/appcompat/widget/N;->k(II)I
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/N;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/N;->a(IZ)Z
    ...
    :cond_5
    invoke-virtual {p1, v0, v5}, Landroidx/appcompat/widget/N;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/N;->f(II)I
    ...
    invoke-virtual {p1, v0, v3}, Landroidx/appcompat/widget/N;->k(II)I
...
.method private initErrorIconView(Landroidx/appcompat/widget/N;)V
    .locals 2
    ...
    invoke-static {v1, p1, v0}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/N;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/N;->k(II)I
...
.method private initSuffixTextView(Landroidx/appcompat/widget/N;)V
    .locals 4
    ...
    invoke-static {v0, v1}, Landroidx/core/view/b0;->p0(Landroid/view/View;I)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/N;->c(I)Landroid/content/res/ColorStateList;
...
.method private removeTouchExplorationStateChangeListenerIfNeeded()V
    ...
    invoke-static {v1, v0}, Lb2/c;->b(Landroid/view/accessibility/AccessibilityManager;Lb2/c$a;)Z
...
.method private setUpDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/textfield/EndIconDelegate;->getTouchExplorationStateChangeListener()Lb2/c$a;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lb2/c$a;
...
.method private tearDownDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:Lb2/c$a;
...
.method getSuffixTextEndOffset()I
    ...
    :goto_1
    invoke-static {p0}, Landroidx/core/view/b0;->D(Landroid/view/View;)I

    move-result v1

    iget-object v2, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->suffixTextView:Landroid/widget/TextView;

    invoke-static {v2}, Landroidx/core/view/b0;->D(Landroid/view/View;)I
...
.method updateSuffixTextViewPadding()V
    ...
    invoke-static {v1, v2, v3, v0, v4}, Landroidx/core/view/b0;->C0(Landroid/view/View;IIII)V
