...
.method private static captureValues(Landroidx/transition/E;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
    .locals 2
    ...
    iget-object p1, p0, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    :goto_2
    iget-object v0, p0, Landroidx/transition/E;->a:Ljava/util/Map;
...
.method private static getElevationOrDefault(FLandroid/view/View;)F
    ...
    :cond_0
    invoke-static {p1}, Landroidx/core/view/b0;->u(Landroid/view/View;)F
...
.method public captureEndValues(Landroidx/transition/E;)V
    ...
    invoke-static {p1, v0, v1, v2}, Lcom/google/android/material/transition/MaterialContainerTransform;->captureValues(Landroidx/transition/E;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    :cond_0
    iget-object v4, v0, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    :cond_1
    iget-object v4, v2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    :cond_2
    iget-object v4, v0, Landroidx/transition/E;->b:Landroid/view/View;

    iget-object v12, v2, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    invoke-virtual {v1, v0}, Landroidx/transition/Transition;->addListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;
