...
.field private final tracer:Lf6/w;
...
.method constructor <init>(Lcom/google/api/client/http/HttpTransport;Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/google/api/client/http/OpenCensusUtils;->getTracer()Lf6/w;

    move-result-object v0

    iput-object v0, p0, Lcom/google/api/client/http/HttpRequest;->tracer:Lf6/w;
...
.method private static addSpanAttribute(Lf6/o;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p2}, Lf6/a;->b(Ljava/lang/String;)Lf6/a;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lf6/o;->g(Ljava/lang/String;Lf6/a;)V
...
.method public execute()Lcom/google/api/client/http/HttpResponse;
    ...
    iget-object v4, v1, Lcom/google/api/client/http/HttpRequest;->tracer:Lf6/w;

    sget-object v5, Lcom/google/api/client/http/OpenCensusUtils;->SPAN_NAME_HTTP_REQUEST_EXECUTE:Ljava/lang/String;

    invoke-virtual {v4, v5}, Lf6/w;->b(Ljava/lang/String;)Lf6/p;
    ...
    invoke-virtual {v4, v5}, Lf6/p;->a(Z)Lf6/p;

    move-result-object v4

    invoke-virtual {v4}, Lf6/p;->b()Lf6/o;
    ...
    invoke-virtual {v4, v7}, Lf6/o;->a(Ljava/lang/String;)V
    ...
    invoke-static {v4, v7, v8}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lf6/o;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v8, v7}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lf6/o;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v7, v0}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lf6/o;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v13, v15}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lf6/o;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v13, v14}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lf6/o;Ljava/lang/String;Ljava/lang/String;)V

    :cond_9
    :goto_5
    iget-object v13, v1, Lcom/google/api/client/http/HttpRequest;->headers:Lcom/google/api/client/http/HttpHeaders;

    invoke-static {v4, v13}, Lcom/google/api/client/http/OpenCensusUtils;->propagateTracingContext(Lf6/o;Lcom/google/api/client/http/HttpHeaders;)V
    ...
    iget-object v0, v1, Lcom/google/api/client/http/HttpRequest;->tracer:Lf6/w;

    invoke-virtual {v0, v4}, Lf6/w;->d(Lf6/o;)Lc6/a;
    ...
    invoke-static {v4, v5, v6}, Lcom/google/api/client/http/OpenCensusUtils;->recordSentMessageEvent(Lf6/o;J)V
    ...
    invoke-static {v4, v6, v7}, Lcom/google/api/client/http/OpenCensusUtils;->recordReceivedMessageEvent(Lf6/o;J)V
    ...
    invoke-static {v6, v7}, Lf6/a;->a(J)Lf6/a;

    move-result-object v6

    invoke-virtual {v4, v0, v6}, Lf6/o;->g(Ljava/lang/String;Lf6/a;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v3}, Lc6/a;->close()V
    ...
    :cond_1b
    invoke-static/range {v16 .. v16}, Lcom/google/api/client/http/OpenCensusUtils;->getEndSpanOptions(Ljava/lang/Integer;)Lf6/m;

    move-result-object v2

    invoke-virtual {v4, v2}, Lf6/o;->e(Lf6/m;)V
    ...
    :goto_18
    invoke-static {v5}, Lcom/google/api/client/http/OpenCensusUtils;->getEndSpanOptions(Ljava/lang/Integer;)Lf6/m;
