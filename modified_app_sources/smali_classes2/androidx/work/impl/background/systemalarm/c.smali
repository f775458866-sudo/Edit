...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/g;)V
    ...
    invoke-direct {p2, p1, p3}, Lj4/e;-><init>(Ll4/m;Lj4/c;)V

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lj4/e;
...
.method a()V
    ...
    invoke-interface {v0}, Lm4/v;->c()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lj4/e;

    invoke-virtual {v1, v0}, Lj4/e;->a(Ljava/lang/Iterable;)V
    ...
    iget-object v5, v4, Lm4/u;->a:Ljava/lang/String;
    ...
    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lj4/e;

    invoke-virtual {v6, v5}, Lj4/e;->d(Ljava/lang/String;)Z
    ...
    iget-object v4, v3, Lm4/u;->a:Ljava/lang/String;

    iget-object v5, p0, Landroidx/work/impl/background/systemalarm/c;->a:Landroid/content/Context;

    invoke-static {v3}, Lm4/x;->a(Lm4/u;)Lm4/m;

    move-result-object v3

    invoke-static {v5, v3}, Landroidx/work/impl/background/systemalarm/b;->b(Landroid/content/Context;Lm4/m;)Landroid/content/Intent;
    ...
    invoke-virtual {v4}, Landroidx/work/impl/background/systemalarm/g;->f()Lo4/b;
    ...
    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->c:Landroidx/work/impl/background/systemalarm/g;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lj4/e;

    invoke-virtual {v0}, Lj4/e;->reset()V
