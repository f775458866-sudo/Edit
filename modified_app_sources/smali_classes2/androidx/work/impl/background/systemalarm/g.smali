...
.field private final i:Landroidx/work/impl/E;
...
.field private q:Landroidx/work/impl/background/systemalarm/g$c;

.field private x:Landroidx/work/impl/w;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/work/impl/background/systemalarm/g;->y:Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Landroidx/work/impl/r;Landroidx/work/impl/E;)V
    ...
    iput-object v1, p0, Landroidx/work/impl/background/systemalarm/g;->x:Landroidx/work/impl/w;

    .line 5
    new-instance v1, Landroidx/work/impl/background/systemalarm/b;

    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->x:Landroidx/work/impl/w;
    ...
    :goto_0
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/g;->i:Landroidx/work/impl/E;

    .line 7
    new-instance p1, Ln4/C;

    invoke-virtual {p3}, Landroidx/work/impl/E;->i()Landroidx/work/b;
    ...
    invoke-direct {p1, v0}, Ln4/C;-><init>(Landroidx/work/t;)V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->f:Ln4/C;
    ...
    .line 8
    :cond_1
    invoke-virtual {p3}, Landroidx/work/impl/E;->m()Landroidx/work/impl/r;
    ...
    .line 9
    invoke-virtual {p3}, Landroidx/work/impl/E;->q()Lo4/b;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->d:Lo4/b;
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->o:Ljava/util/List;

    const/4 p1, 0x0

    .line 12
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->p:Landroid/content/Intent;
...
.method private i(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->o:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/g;->o:Ljava/util/List;
...
.method private k()V
    ...
    invoke-static {v0, v1}, Ln4/w;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/g;->i:Landroidx/work/impl/E;
    ...
    invoke-interface {v1, v2}, Lo4/b;->c(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public a(Landroid/content/Intent;I)Z
    ...
    sget-object v1, Landroidx/work/impl/background/systemalarm/g;->y:Ljava/lang/String;
    ...
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/g;->o:Ljava/util/List;
...
.method c()V
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->p:Landroid/content/Intent;
    ...
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/g;->p:Landroid/content/Intent;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->o:Ljava/util/List;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/g;->p:Landroid/content/Intent;
    ...
    iput-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->p:Landroid/content/Intent;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->d:Lo4/b;

    invoke-interface {v2}, Lo4/b;->b()Lo4/a;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/g;->o:Ljava/util/List;
    ...
    invoke-interface {v2}, Lo4/a;->n0()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/g;->q:Landroidx/work/impl/background/systemalarm/g$c;
...
.method public e(Lm4/m;Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->d:Lo4/b;
    ...
    invoke-static {v2, p1, p2}, Landroidx/work/impl/background/systemalarm/b;->c(Landroid/content/Context;Lm4/m;Z)Landroid/content/Intent;
...
.method g()Landroidx/work/impl/E;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->i:Landroidx/work/impl/E;
...
.method h()Ln4/C;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->f:Ln4/C;
...
.method j()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->q:Landroidx/work/impl/background/systemalarm/g$c;
...
.method l(Landroidx/work/impl/background/systemalarm/g$c;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->q:Landroidx/work/impl/background/systemalarm/g$c;
    ...
    sget-object v0, Landroidx/work/impl/background/systemalarm/g;->y:Ljava/lang/String;
    ...
    :cond_0
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->q:Landroidx/work/impl/background/systemalarm/g$c;
