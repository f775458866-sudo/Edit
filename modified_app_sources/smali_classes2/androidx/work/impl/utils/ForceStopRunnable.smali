...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/E;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:Landroidx/work/impl/E;

    invoke-virtual {p2}, Landroidx/work/impl/E;->l()Ln4/q;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->f:Ln4/q;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:Landroidx/work/impl/E;

    invoke-static {v0, v1}, Landroidx/work/impl/background/systemjob/e;->i(Landroid/content/Context;Landroidx/work/impl/E;)Z
    ...
    :try_start_0
    invoke-interface {v2}, Lm4/v;->q()Ljava/util/List;
    ...
    sget-object v9, Landroidx/work/v;->c:Landroidx/work/v;

    iget-object v10, v8, Lm4/u;->a:Ljava/lang/String;

    invoke-interface {v2, v9, v10}, Lm4/v;->o(Landroidx/work/v;Ljava/lang/String;)I

    iget-object v8, v8, Lm4/u;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, Lm4/v;->l(Ljava/lang/String;J)I

    goto :goto_1

    :cond_1
    invoke-interface {v3}, Lm4/r;->b()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:Landroidx/work/impl/E;

    invoke-virtual {v0}, Landroidx/work/impl/E;->t()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:Landroidx/work/impl/E;

    invoke-virtual {v0}, Landroidx/work/impl/E;->l()Ln4/q;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ln4/q;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->f:Ln4/q;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Ln4/q;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:Landroidx/work/impl/E;

    invoke-virtual {v2}, Landroidx/work/impl/E;->n()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, Ln4/e;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->f:Ln4/q;

    invoke-virtual {v2}, Ln4/q;->a()J
    ...
    invoke-static {v6}, Ln4/f;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, Ln4/g;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, Ln4/h;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, Landroidx/work/m;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/E;->s()V
    ...
    invoke-virtual {v0}, Landroidx/work/b;->e()La2/a;
    ...
    invoke-interface {v0, v2}, La2/a;->accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/E;->s()V
