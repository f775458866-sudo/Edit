...
.method private M(Landroidx/recyclerview/widget/RecyclerView$D;IIJ)Z
    ...
    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$D;->mBindingAdapter:Landroidx/recyclerview/widget/RecyclerView$h;
    ...
    invoke-virtual {p4, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$h;->bindViewHolder(Landroidx/recyclerview/widget/RecyclerView$D;I)V
...
.method private b(Landroidx/recyclerview/widget/RecyclerView$D;)V
    ...
    invoke-static {p1}, Landroidx/core/view/b0;->x(Landroid/view/View;)I
    ...
    invoke-static {p1, v0}, Landroidx/core/view/b0;->x0(Landroid/view/View;I)V
    ...
    :cond_1
    invoke-virtual {v0}, Landroidx/recyclerview/widget/p;->getItemDelegate()Landroidx/core/view/a;
    ...
    :cond_2
    invoke-static {p1, v0}, Landroidx/core/view/b0;->n0(Landroid/view/View;Landroidx/core/view/a;)V
...
.method A()V
    ...
    invoke-static {v1}, Lg2/a;->b(Landroid/view/View;)V
...
.method H(Landroidx/recyclerview/widget/RecyclerView$D;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/RecyclerView$h;->onFailedToRecycleView(Landroidx/recyclerview/widget/RecyclerView$D;)Z
    ...
    invoke-static {v0}, Lg2/a;->b(Landroid/view/View;)V
...
.method N(IZJ)Landroidx/recyclerview/widget/RecyclerView$D;
    ...
    invoke-virtual {v2, v8}, Landroidx/recyclerview/widget/RecyclerView$D;->addFlags(I)V

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$D;->isScrap()Z
    ...
    iget-object v9, v2, Landroidx/recyclerview/widget/RecyclerView$D;->itemView:Landroid/view/View;

    invoke-virtual {v8, v9, v7}, Landroidx/recyclerview/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$D;->unScrap()V

    goto :goto_1

    :cond_2
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$D;->wasReturnedFromScrap()Z

    move-result v8

    if-eqz v8, :cond_3

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$D;->clearReturnedFromScrapFlag()V
    ...
    iput v8, v2, Landroidx/recyclerview/widget/RecyclerView$D;->mPosition:I
    ...
    invoke-virtual {v1, v11}, Landroidx/recyclerview/widget/RecyclerView$u;->h(I)Landroidx/recyclerview/widget/RecyclerView$D;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$D;->resetInternal()V
    ...
    invoke-virtual {v2, v1, v11}, Landroidx/recyclerview/widget/RecyclerView$h;->createViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$D;
    ...
    iput-object v4, v2, Landroidx/recyclerview/widget/RecyclerView$D;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v1, v2}, Landroidx/recyclerview/widget/RecyclerView$D;->hasAnyOfTheFlags(I)Z

    move-result v4

    if-eqz v4, :cond_e

    invoke-virtual {v1, v7, v2}, Landroidx/recyclerview/widget/RecyclerView$D;->setFlags(II)V
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$m;
    ...
    invoke-virtual {v5, v4, v1, v2, v9}, Landroidx/recyclerview/widget/RecyclerView$m;->t(Landroidx/recyclerview/widget/RecyclerView$z;Landroidx/recyclerview/widget/RecyclerView$D;ILjava/util/List;)Landroidx/recyclerview/widget/RecyclerView$m$b;

    move-result-object v2

    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView$v;->h:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v4, v1, v2}, Landroidx/recyclerview/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$D;Landroidx/recyclerview/widget/RecyclerView$m$b;)V
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$D;->isBound()Z

    move-result v2

    if-eqz v2, :cond_f

    iput v3, v1, Landroidx/recyclerview/widget/RecyclerView$D;->mPreLayoutPosition:I
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$D;->needsUpdate()Z

    move-result v2

    if-nez v2, :cond_11

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$D;->isInvalid()Z
    ...
    :goto_7
    iput-object v1, v3, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->a:Landroidx/recyclerview/widget/RecyclerView$D;
...
.method a(Landroidx/recyclerview/widget/RecyclerView$D;Z)V
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/p;->getItemDelegate()Landroidx/core/view/a;
    ...
    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/p$a;->c(Landroid/view/View;)Landroidx/core/view/a;
    ...
    :goto_0
    invoke-static {v0, v1}, Landroidx/core/view/b0;->n0(Landroid/view/View;Landroidx/core/view/a;)V
    ...
    :cond_2
    iput-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$D;->mBindingAdapter:Landroidx/recyclerview/widget/RecyclerView$h;
...
.method g(Landroidx/recyclerview/widget/RecyclerView$D;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$h;->onViewRecycled(Landroidx/recyclerview/widget/RecyclerView$D;)V
