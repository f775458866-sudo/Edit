...
.method private A(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v0, Landroidx/transition/ChangeImageTransform;->f:Landroid/util/Property;
...
.method private w(Landroidx/transition/E;Z)V
    .locals 6
    ...
    sget p2, Landroidx/transition/o;->transition_image_transform:I
    ...
    invoke-static {v1}, Landroidx/transition/ChangeImageTransform;->y(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private static x(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 5
...
.method private static y(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 2
    ...
    :cond_0
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->x(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private z(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 2

    sget-object v0, Landroidx/transition/ChangeImageTransform;->f:Landroid/util/Property;

    new-instance v1, Landroidx/transition/D$b;

    invoke-direct {v1}, Landroidx/transition/D$b;-><init>()V
...
.method public captureEndValues(Landroidx/transition/E;)V
    ...
    invoke-direct {p0, p1, v0}, Landroidx/transition/ChangeImageTransform;->w(Landroidx/transition/E;Z)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object p2, p2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object v3, p3, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    :cond_5
    iget-object p1, p3, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->z(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
