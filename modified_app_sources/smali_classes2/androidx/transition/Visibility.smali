...
.method private w(Landroidx/transition/E;Landroidx/transition/E;)Landroidx/transition/Visibility$c;
    .locals 7
    ...
    iget-object v6, p1, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object v6, p2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object v2, p2, Landroidx/transition/E;->a:Ljava/util/Map;
...
.method public captureEndValues(Landroidx/transition/E;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/Visibility;->captureValues(Landroidx/transition/E;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, p2, p3}, Landroidx/transition/Visibility;->w(Landroidx/transition/E;Landroidx/transition/E;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/transition/Visibility;->onAppear(Landroid/view/ViewGroup;Landroidx/transition/E;ILandroidx/transition/E;I)Landroid/animation/Animator;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/Visibility;->onDisappear(Landroid/view/ViewGroup;Landroidx/transition/E;ILandroidx/transition/E;I)Landroid/animation/Animator;
...
.method public isTransitionRequired(Landroidx/transition/E;Landroidx/transition/E;)Z
    ...
    iget-object v1, p2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object v3, p1, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/transition/Visibility;->w(Landroidx/transition/E;Landroidx/transition/E;)Landroidx/transition/Visibility$c;
...
.method public isVisible(Landroidx/transition/E;)Z
    .locals 3
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    .locals 0
...
.method public onAppear(Landroid/view/ViewGroup;Landroidx/transition/E;ILandroidx/transition/E;I)Landroid/animation/Animator;
    .locals 2
    ...
    .line 3
    iget-object p3, p4, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    .line 4
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;

    move-result-object v1

    .line 5
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;

    move-result-object p3

    .line 6
    invoke-direct {p0, v1, p3}, Landroidx/transition/Visibility;->w(Landroidx/transition/E;Landroidx/transition/E;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual {p0, p1, p3, p2, p4}, Landroidx/transition/Visibility;->onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    .locals 0
...
.method public onDisappear(Landroid/view/ViewGroup;Landroidx/transition/E;ILandroidx/transition/E;I)Landroid/animation/Animator;
    .locals 10
    ...
    .line 3
    :cond_1
    iget-object p3, p2, Landroidx/transition/E;->b:Landroid/view/View;

    if-eqz p4, :cond_2

    .line 4
    iget-object v2, p4, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    .line 5
    :goto_0
    sget v3, Landroidx/transition/o;->save_overlay_view:I
    ...
    .line 10
    invoke-virtual {p0, v7, v6}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;

    move-result-object v8

    .line 11
    invoke-virtual {p0, v7, v6}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;

    move-result-object v9

    .line 12
    invoke-direct {p0, v8, v9}, Landroidx/transition/Visibility;->w(Landroidx/transition/E;Landroidx/transition/E;)Landroidx/transition/Visibility$c;
    ...
    .line 14
    invoke-static {p1, p3, v7}, Landroidx/transition/D;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    .line 18
    iget-object p5, p2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    .line 26
    :cond_b
    invoke-virtual {p0, p1, v4, p2, p4}, Landroidx/transition/Visibility;->onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    invoke-virtual {p1, p4}, Landroidx/transition/Transition;->addListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;
    ...
    .line 34
    invoke-static {v2, v5}, Landroidx/transition/J;->g(Landroid/view/View;I)V

    .line 35
    invoke-virtual {p0, p1, v2, p2, p4}, Landroidx/transition/Visibility;->onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    invoke-virtual {p3, p2}, Landroidx/transition/Transition;->addListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;

    return-object p1

    .line 39
    :cond_f
    invoke-static {v2, p3}, Landroidx/transition/J;->g(Landroid/view/View;I)V
