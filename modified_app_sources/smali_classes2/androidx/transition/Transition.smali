...
.field private mEndValues:Landroidx/transition/F;
...
.field private mListenersCache:[Landroidx/transition/Transition$i;
...
.field mPropagation:Landroidx/transition/B;

.field mSeekController:Landroidx/transition/Transition$h;

.field mSeekOffsetInParent:J

.field private mStartDelay:J

.field private mStartValues:Landroidx/transition/F;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;
    ...
    iput-object v1, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;
...
.method private a(Landroidx/collection/a;Landroidx/collection/a;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/collection/X;->l(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroidx/transition/E;

    iget-object v4, v2, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    :cond_1
    :goto_1
    invoke-virtual {p2}, Landroidx/collection/X;->size()I

    move-result p1

    if-ge v0, p1, :cond_3

    invoke-virtual {p2, v0}, Landroidx/collection/X;->l(I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/transition/E;

    iget-object v1, p1, Landroidx/transition/E;->b:Landroid/view/View;
...
.method private static b(Landroidx/transition/F;Landroid/view/View;Landroidx/transition/E;)V
    .locals 3

    iget-object v0, p0, Landroidx/transition/F;->a:Landroidx/collection/a;
    ...
    iget-object v1, p0, Landroidx/transition/F;->b:Landroid/util/SparseArray;
    ...
    :cond_1
    :goto_0
    invoke-static {p1}, Landroidx/core/view/b0;->I(Landroid/view/View;)Ljava/lang/String;

    move-result-object p2

    if-eqz p2, :cond_3

    iget-object v1, p0, Landroidx/transition/F;->d:Landroidx/collection/a;
    ...
    invoke-virtual {v1, p2, v0}, Landroidx/collection/X;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p2, p1}, Landroidx/collection/X;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Landroidx/transition/F;->c:Landroidx/collection/v;

    invoke-virtual {p2, v1, v2}, Landroidx/collection/v;->f(J)I

    move-result p2

    if-ltz p2, :cond_4

    iget-object p1, p0, Landroidx/transition/F;->c:Landroidx/collection/v;

    invoke-virtual {p1, v1, v2}, Landroidx/collection/v;->d(J)Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/transition/F;->c:Landroidx/collection/v;

    invoke-virtual {p0, v1, v2, v0}, Landroidx/collection/v;->j(JLjava/lang/Object;)V
    ...
    invoke-virtual {p0, v1, v2, p1}, Landroidx/collection/v;->j(JLjava/lang/Object;)V
...
.method private d(Landroid/view/View;Z)V
    ...
    invoke-direct {v1, p1}, Landroidx/transition/E;-><init>(Landroid/view/View;)V

    if-eqz p2, :cond_5

    invoke-virtual {p0, v1}, Landroidx/transition/Transition;->captureStartValues(Landroidx/transition/E;)V

    goto :goto_1

    :cond_5
    invoke-virtual {p0, v1}, Landroidx/transition/Transition;->captureEndValues(Landroidx/transition/E;)V

    :goto_1
    iget-object v3, v1, Landroidx/transition/E;->c:Ljava/util/ArrayList;

    invoke-virtual {v3, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0, v1}, Landroidx/transition/Transition;->capturePropagationValues(Landroidx/transition/E;)V

    if-eqz p2, :cond_6

    iget-object v3, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    invoke-static {v3, p1, v1}, Landroidx/transition/Transition;->b(Landroidx/transition/F;Landroid/view/View;Landroidx/transition/E;)V

    goto :goto_2

    :cond_6
    iget-object v3, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;
...
.method private static h(Ljava/util/ArrayList;Ljava/lang/Object;Z)Ljava/util/ArrayList;
    .locals 0
...
.method private i(Ljava/util/ArrayList;Ljava/lang/Class;Z)Ljava/util/ArrayList;
    .locals 0
...
.method private j(Ljava/util/ArrayList;Landroid/view/View;Z)Ljava/util/ArrayList;
    .locals 0
...
.method private static k()Landroidx/collection/a;
    .locals 2
...
.method private static m(Landroidx/transition/E;Landroidx/transition/E;Ljava/lang/String;)Z
    .locals 0

    iget-object p0, p0, Landroidx/transition/E;->a:Ljava/util/Map;
...
.method private n(Landroidx/collection/a;Landroidx/collection/a;Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    check-cast v4, Landroidx/transition/E;
...
.method private o(Landroidx/collection/a;Landroidx/collection/a;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/collection/X;->g(I)Ljava/lang/Object;
    ...
    iget-object v2, v1, Landroidx/transition/E;->b:Landroid/view/View;
...
.method private p(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/v;Landroidx/collection/v;)V
    .locals 7

    invoke-virtual {p3}, Landroidx/collection/v;->m()I
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/v;->n(I)Ljava/lang/Object;
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/v;->i(I)J

    move-result-wide v3

    invoke-virtual {p4, v3, v4}, Landroidx/collection/v;->d(J)Ljava/lang/Object;
...
.method private q(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/a;)V
    ...
    invoke-virtual {p3}, Landroidx/collection/X;->size()I
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/X;->l(I)Ljava/lang/Object;
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/X;->g(I)Ljava/lang/Object;
...
.method private r(Landroidx/transition/F;Landroidx/transition/F;)V
    .locals 5

    new-instance v0, Landroidx/collection/a;

    iget-object v1, p1, Landroidx/transition/F;->a:Landroidx/collection/a;

    invoke-direct {v0, v1}, Landroidx/collection/a;-><init>(Landroidx/collection/X;)V

    new-instance v1, Landroidx/collection/a;

    iget-object v2, p2, Landroidx/transition/F;->a:Landroidx/collection/a;

    invoke-direct {v1, v2}, Landroidx/collection/a;-><init>(Landroidx/collection/X;)V
    ...
    :cond_0
    iget-object v3, p1, Landroidx/transition/F;->c:Landroidx/collection/v;

    iget-object v4, p2, Landroidx/transition/F;->c:Landroidx/collection/v;

    invoke-direct {p0, v0, v1, v3, v4}, Landroidx/transition/Transition;->p(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/v;Landroidx/collection/v;)V

    goto :goto_1

    :cond_1
    iget-object v3, p1, Landroidx/transition/F;->b:Landroid/util/SparseArray;

    iget-object v4, p2, Landroidx/transition/F;->b:Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v3, p1, Landroidx/transition/F;->d:Landroidx/collection/a;

    iget-object v4, p2, Landroidx/transition/F;->d:Landroidx/collection/a;
    ...
    :cond_4
    invoke-direct {p0, v0, v1}, Landroidx/transition/Transition;->a(Landroidx/collection/a;Landroidx/collection/a;)V

    return-void
.end method

.method private s(Landroidx/transition/Transition;Landroidx/transition/Transition$j;Z)V
    .locals 5
    ...
    invoke-direct {v0, p1, p2, p3}, Landroidx/transition/Transition;->s(Landroidx/transition/Transition;Landroidx/transition/Transition$j;Z)V
    ...
    iget-object v1, p0, Landroidx/transition/Transition;->mListenersCache:[Landroidx/transition/Transition$i;
    ...
    iput-object v2, p0, Landroidx/transition/Transition;->mListenersCache:[Landroidx/transition/Transition$i;
    ...
    invoke-interface {p2, v4, p1, p3}, Landroidx/transition/Transition$j;->b(Landroidx/transition/Transition$i;Landroidx/transition/Transition;Z)V
    ...
    :cond_2
    iput-object v1, p0, Landroidx/transition/Transition;->mListenersCache:[Landroidx/transition/Transition$i;
...
# virtual methods
.method public addListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;
    .locals 1
...
.method protected cancel()V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$j;Z)V

    return-void
.end method

.method public abstract captureEndValues(Landroidx/transition/E;)V
.end method

.method capturePropagationValues(Landroidx/transition/E;)V
    .locals 4

    iget-object v0, p0, Landroidx/transition/Transition;->mPropagation:Landroidx/transition/B;

    if-eqz v0, :cond_2

    iget-object v0, p1, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    invoke-virtual {v0}, Landroidx/transition/B;->b()[Ljava/lang/String;
    ...
    iget-object v2, p1, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    invoke-virtual {v0, p1}, Landroidx/transition/B;->a(Landroidx/transition/E;)V
...
.method public abstract captureStartValues(Landroidx/transition/E;)V
.end method
...
.method captureValues(Landroid/view/ViewGroup;Z)V
    ...
    invoke-direct {v3, v2}, Landroidx/transition/E;-><init>(Landroid/view/View;)V

    if-eqz p2, :cond_4

    invoke-virtual {p0, v3}, Landroidx/transition/Transition;->captureStartValues(Landroidx/transition/E;)V

    goto :goto_2

    :cond_4
    invoke-virtual {p0, v3}, Landroidx/transition/Transition;->captureEndValues(Landroidx/transition/E;)V

    :goto_2
    iget-object v4, v3, Landroidx/transition/E;->c:Ljava/util/ArrayList;

    invoke-virtual {v4, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0, v3}, Landroidx/transition/Transition;->capturePropagationValues(Landroidx/transition/E;)V

    if-eqz p2, :cond_5

    iget-object v4, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    invoke-static {v4, v2, v3}, Landroidx/transition/Transition;->b(Landroidx/transition/F;Landroid/view/View;Landroidx/transition/E;)V

    goto :goto_3

    :cond_5
    iget-object v4, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;
    ...
    invoke-direct {v2, v0}, Landroidx/transition/E;-><init>(Landroid/view/View;)V

    if-eqz p2, :cond_8

    invoke-virtual {p0, v2}, Landroidx/transition/Transition;->captureStartValues(Landroidx/transition/E;)V

    goto :goto_5

    :cond_8
    invoke-virtual {p0, v2}, Landroidx/transition/Transition;->captureEndValues(Landroidx/transition/E;)V

    :goto_5
    iget-object v3, v2, Landroidx/transition/E;->c:Ljava/util/ArrayList;

    invoke-virtual {v3, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0, v2}, Landroidx/transition/Transition;->capturePropagationValues(Landroidx/transition/E;)V

    if-eqz p2, :cond_9

    iget-object v3, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    invoke-static {v3, v0, v2}, Landroidx/transition/Transition;->b(Landroidx/transition/F;Landroid/view/View;Landroidx/transition/E;)V
    ...
    invoke-virtual {v2, v0}, Landroidx/collection/X;->g(I)Ljava/lang/Object;
    ...
    iget-object v3, v3, Landroidx/transition/F;->d:Landroidx/collection/a;
    ...
    invoke-virtual {v2, v1}, Landroidx/collection/X;->l(I)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v2, v0}, Landroidx/collection/X;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method clearValues(Z)V
    ...
    iget-object p1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    iget-object p1, p1, Landroidx/transition/F;->a:Landroidx/collection/a;

    invoke-virtual {p1}, Landroidx/collection/X;->clear()V

    iget-object p1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    iget-object p1, p1, Landroidx/transition/F;->b:Landroid/util/SparseArray;

    invoke-virtual {p1}, Landroid/util/SparseArray;->clear()V

    iget-object p1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    iget-object p1, p1, Landroidx/transition/F;->c:Landroidx/collection/v;

    invoke-virtual {p1}, Landroidx/collection/v;->a()V

    return-void

    :cond_0
    iget-object p1, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;
...
.method public clone()Landroidx/transition/Transition;
    ...
    iput-object v1, v0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;
    ...
    iput-object v1, v0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;
    ...
    .line 8
    iput-object v1, v0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;
...
.method createAnimators(Landroid/view/ViewGroup;Landroidx/transition/F;Landroidx/transition/F;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-static {}, Landroidx/transition/Transition;->k()Landroidx/collection/a;
    ...
    iget-object v0, v0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;
    ...
    iget-object v6, v2, Landroidx/transition/E;->c:Ljava/util/ArrayList;
    ...
    iget-object v6, v4, Landroidx/transition/E;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v2, v4}, Landroidx/transition/Transition;->isTransitionRequired(Landroidx/transition/E;Landroidx/transition/E;)Z
    ...
    :cond_5
    invoke-virtual {v3, v7, v2, v4}, Landroidx/transition/Transition;->createAnimator(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    iget-object v5, v4, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    invoke-direct {v6, v5}, Landroidx/transition/E;-><init>(Landroid/view/View;)V
    ...
    iget-object v12, v10, Landroidx/transition/F;->a:Landroidx/collection/a;

    invoke-virtual {v12, v5}, Landroidx/collection/a;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Landroidx/transition/E;
    ...
    iget-object v13, v6, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object v11, v12, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    :cond_6
    invoke-virtual {v8}, Landroidx/collection/X;->size()I
    ...
    invoke-virtual {v8, v11}, Landroidx/collection/X;->g(I)Ljava/lang/Object;
    ...
    iget-object v13, v12, Landroidx/transition/Transition$d;->c:Landroidx/transition/E;
    ...
    iget-object v5, v12, Landroidx/transition/Transition$d;->c:Landroidx/transition/E;

    invoke-virtual {v5, v6}, Landroidx/transition/E;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v5, v2, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    iget-object v10, v3, Landroidx/transition/Transition;->mPropagation:Landroidx/transition/B;

    if-eqz v10, :cond_c

    invoke-virtual {v10, v7, v3, v2, v4}, Landroidx/transition/B;->c(Landroid/view/ViewGroup;Landroidx/transition/Transition;Landroidx/transition/E;Landroidx/transition/E;)J
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/transition/Transition$d;-><init>(Landroid/view/View;Ljava/lang/String;Landroidx/transition/Transition;Landroid/view/WindowId;Landroidx/transition/E;Landroid/animation/Animator;)V
    ...
    :goto_6
    invoke-virtual {v8, v1, v0}, Landroidx/collection/X;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method createSeekController()Landroidx/transition/C;
    .locals 1
    ...
    iput-object v0, p0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;

    invoke-virtual {p0, v0}, Landroidx/transition/Transition;->addListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;

    iget-object v0, p0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;
...
.method protected end()V
    ...
    invoke-virtual {p0, v0, v2}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$j;Z)V
    ...
    iget-object v3, v3, Landroidx/transition/F;->c:Landroidx/collection/v;
    ...
    invoke-virtual {v3, v0}, Landroidx/collection/v;->n(I)Ljava/lang/Object;
...
.method public excludeChildren(IZ)Landroidx/transition/Transition;
    ...
    invoke-direct {p0, v0, p1, p2}, Landroidx/transition/Transition;->f(Ljava/util/ArrayList;IZ)Ljava/util/ArrayList;
...
.method public excludeChildren(Landroid/view/View;Z)Landroidx/transition/Transition;
    ...
    invoke-direct {p0, v0, p1, p2}, Landroidx/transition/Transition;->j(Ljava/util/ArrayList;Landroid/view/View;Z)Ljava/util/ArrayList;
...
.method public excludeChildren(Ljava/lang/Class;Z)Landroidx/transition/Transition;
    ...
    invoke-direct {p0, v0, p1, p2}, Landroidx/transition/Transition;->i(Ljava/util/ArrayList;Ljava/lang/Class;Z)Ljava/util/ArrayList;
...
.method public excludeTarget(Ljava/lang/String;Z)Landroidx/transition/Transition;
    ...
    invoke-static {v0, p1, p2}, Landroidx/transition/Transition;->h(Ljava/util/ArrayList;Ljava/lang/Object;Z)Ljava/util/ArrayList;
...
.method forceToEnd(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v2, v0}, Landroidx/collection/a;-><init>(Landroidx/collection/X;)V
    ...
    invoke-virtual {v2, v1}, Landroidx/collection/X;->g(I)Ljava/lang/Object;
...
.method getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;
    .locals 5
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;
    ...
    :cond_3
    iget-object v4, v4, Landroidx/transition/E;->b:Landroid/view/View;
...
.method public getPropagation()Landroidx/transition/B;
    .locals 1
...
.method public getTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;
    ...
    iget-object p2, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;

    :goto_0
    iget-object p2, p2, Landroidx/transition/F;->a:Landroidx/collection/a;
...
.method public isTransitionRequired(Landroidx/transition/E;Landroidx/transition/E;)Z
    .locals 6
    ...
    invoke-static {p1, p2, v5}, Landroidx/transition/Transition;->m(Landroidx/transition/E;Landroidx/transition/E;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v3}, Landroidx/transition/Transition;->m(Landroidx/transition/E;Landroidx/transition/E;Ljava/lang/String;)Z
...
.method notifyListeners(Landroidx/transition/Transition$j;Z)V
    .locals 0

    invoke-direct {p0, p0, p1, p2}, Landroidx/transition/Transition;->s(Landroidx/transition/Transition;Landroidx/transition/Transition$j;Z)V
...
.method public pause(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$j;Z)V
...
.method playTransition(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    iget-object v1, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;

    invoke-direct {p0, v0, v1}, Landroidx/transition/Transition;->r(Landroidx/transition/F;Landroidx/transition/F;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/collection/X;->g(I)Ljava/lang/Object;
    ...
    iget-object v6, v5, Landroidx/transition/Transition$d;->c:Landroidx/transition/E;

    iget-object v7, v5, Landroidx/transition/Transition$d;->a:Landroid/view/View;

    invoke-virtual {p0, v7, v3}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;

    move-result-object v8

    invoke-virtual {p0, v7, v3}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;
    ...
    iget-object v9, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;

    iget-object v9, v9, Landroidx/transition/F;->a:Landroidx/collection/a;
    ...
    check-cast v9, Landroidx/transition/E;
    ...
    invoke-virtual {v7, v6, v9}, Landroidx/transition/Transition;->isTransitionRequired(Landroidx/transition/E;Landroidx/transition/E;)Z
    ...
    iget-object v6, v6, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;
    ...
    invoke-virtual {v5, v4, v6}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$j;Z)V
    ...
    :cond_6
    iget-object v6, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/F;

    iget-object v7, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/F;
    ...
    invoke-virtual/range {v4 .. v9}, Landroidx/transition/Transition;->createAnimators(Landroid/view/ViewGroup;Landroidx/transition/F;Landroidx/transition/F;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    iget-object p1, v4, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;
    ...
    invoke-virtual {p1}, Landroidx/transition/Transition$h;->i()V

    iget-object p1, v4, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$h;

    invoke-virtual {p1}, Landroidx/transition/Transition$h;->j()V
...
.method public removeListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroidx/transition/Transition;->removeListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;
...
.method protected runAnimators()V
    ...
    invoke-direct {p0, v4, v0}, Landroidx/transition/Transition;->v(Landroid/animation/Animator;Landroidx/collection/a;)V
...
.method setCurrentPlayTimeMillis(JJ)V
    ...
    invoke-virtual {v0, v11, v5}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$j;Z)V
    ...
    invoke-static {v13, v3, v4}, Landroidx/transition/Transition$g;->b(Landroid/animation/Animator;J)V
    ...
    invoke-virtual {v0, v1, v5}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$j;Z)V
...
.method public varargs setMatchOrder([I)V
    ...
    invoke-static {v1}, Landroidx/transition/Transition;->l(I)Z
...
.method public setPropagation(Landroidx/transition/B;)V
    ...
    iput-object p1, p0, Landroidx/transition/Transition;->mPropagation:Landroidx/transition/B;
