...
.method private A(Landroidx/transition/E;Landroidx/transition/E;)V
    .locals 4

    iget-object v0, p2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object p2, p2, Landroidx/transition/E;->b:Landroid/view/View;

    sget v2, Landroidx/transition/o;->parent_matrix:I

    invoke-virtual {p2, v2, v0}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    iget-object p2, p0, Landroidx/transition/ChangeTransform;->f:Landroid/graphics/Matrix;
...
.method static B(Landroid/view/View;FFFFFFFF)V
    .locals 0
    ...
    invoke-static {p0, p3}, Landroidx/core/view/b0;->I0(Landroid/view/View;F)V
...
.method private captureValues(Landroidx/transition/E;)V
    ...
    invoke-static {v2, v1}, Landroidx/transition/J;->h(Landroid/view/View;Landroid/graphics/Matrix;)V
...
.method private w(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)V
    .locals 3

    iget-object v0, p3, Landroidx/transition/E;->b:Landroid/view/View;

    iget-object v1, p3, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    invoke-static {p1, v2}, Landroidx/transition/J;->i(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    iget-object v2, p2, Landroidx/transition/E;->b:Landroid/view/View;
    ...
    invoke-virtual {v1, v2}, Landroidx/transition/Transition;->addListener(Landroidx/transition/Transition$i;)Landroidx/transition/Transition;

    sget-boolean p1, Landroidx/transition/ChangeTransform;->o:Z

    if-eqz p1, :cond_3

    iget-object p1, p2, Landroidx/transition/E;->b:Landroid/view/View;

    iget-object p2, p3, Landroidx/transition/E;->b:Landroid/view/View;

    if-eq p1, p2, :cond_2

    const/4 p2, 0x0

    invoke-static {p1, p2}, Landroidx/transition/J;->f(Landroid/view/View;F)V

    :cond_2
    const/high16 p1, 0x3f800000    # 1.0f

    invoke-static {v0, p1}, Landroidx/transition/J;->f(Landroid/view/View;F)V
...
.method private x(Landroidx/transition/E;Landroidx/transition/E;Z)Landroid/animation/ObjectAnimator;
    .locals 9
    ...
    invoke-static {v2}, Landroidx/transition/ChangeTransform;->z(Landroid/view/View;)V
    ...
    sget-object v1, Landroidx/transition/ChangeTransform;->i:Landroid/util/Property;
    ...
    sget-object v0, Landroidx/transition/ChangeTransform;->j:Landroid/util/Property;
    ...
    iget-boolean v7, p0, Landroidx/transition/ChangeTransform;->c:Z
...
.method private y(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, p1, v1}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/E;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object p1, p1, Landroidx/transition/E;->b:Landroid/view/View;
...
.method static z(Landroid/view/View;)V
    ...
    invoke-static/range {v0 .. v8}, Landroidx/transition/ChangeTransform;->B(Landroid/view/View;FFFFFFFF)V
...
.method public captureEndValues(Landroidx/transition/E;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeTransform;->captureValues(Landroidx/transition/E;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)Landroid/animation/Animator;
    ...
    iget-object v0, p3, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    iget-object v2, p3, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    invoke-direct {p0, v0, v1}, Landroidx/transition/ChangeTransform;->y(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    iget-object v3, p2, Landroidx/transition/E;->a:Ljava/util/Map;
    ...
    invoke-direct {p0, p2, p3}, Landroidx/transition/ChangeTransform;->A(Landroidx/transition/E;Landroidx/transition/E;)V

    :cond_4
    invoke-direct {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->x(Landroidx/transition/E;Landroidx/transition/E;Z)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->w(Landroid/view/ViewGroup;Landroidx/transition/E;Landroidx/transition/E;)V
