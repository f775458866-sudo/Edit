...
.method private d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lj5/l;->a:Landroid/content/Context;
    ...
    iget-object p1, p0, Lj5/l;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lj5/l;->a:Landroid/content/Context;
...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lj5/l;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lj5/l;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;LY4/h;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lj5/l;->h(Landroid/net/Uri;LY4/h;)Z
...
.method public bridge synthetic b(Ljava/lang/Object;IILY4/h;)La5/v;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lj5/l;->c(Landroid/net/Uri;IILY4/h;)La5/v;
...
.method public c(Landroid/net/Uri;IILY4/h;)La5/v;
    ...
    invoke-direct {p0, p1, p2}, Lj5/l;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p3

    invoke-direct {p0, p3, p1}, Lj5/l;->g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    iget-object p2, p0, Lj5/l;->a:Landroid/content/Context;

    invoke-static {p2, p3, p1}, Lj5/i;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object p3, p0, Lj5/l;->a:Landroid/content/Context;

    invoke-static {p3, p1, p2}, Lj5/i;->a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public h(Landroid/net/Uri;LY4/h;)Z
    .locals 0
