...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lu5/a;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static b(Ljava/io/InputStream;)Ljava/nio/ByteBuffer;
    ...
    sget-object v2, Lu5/a;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    sget-object p0, Lu5/a;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-static {p0}, Lu5/a;->d(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
...
.method private static c(Ljava/nio/ByteBuffer;)Lu5/a$b;
    .locals 3
    ...
    invoke-direct {v0, v1, v2, p0}, Lu5/a$b;-><init>([BII)V
...
.method public static e(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {p0}, Lu5/a;->c(Ljava/nio/ByteBuffer;)Lu5/a$b;

    move-result-object v0

    if-eqz v0, :cond_0

    iget v1, v0, Lu5/a$b;->a:I

    if-nez v1, :cond_0

    iget v1, v0, Lu5/a$b;->b:I

    iget-object v0, v0, Lu5/a$b;->c:[B
...
.method public static g(Ljava/nio/ByteBuffer;)Ljava/io/InputStream;
    ...
    invoke-direct {v0, p0}, Lu5/a$a;-><init>(Ljava/nio/ByteBuffer;)V
