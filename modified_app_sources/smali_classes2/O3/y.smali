...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;ILS3/h;)V
    ...
    iput-object p1, p0, LO3/y;->c:Landroid/content/Context;

    iput-object p2, p0, LO3/y;->d:Ljava/lang/String;

    iput-object p3, p0, LO3/y;->f:Ljava/io/File;

    iput-object p4, p0, LO3/y;->g:Ljava/util/concurrent/Callable;

    iput p5, p0, LO3/y;->i:I

    iput-object p6, p0, LO3/y;->j:LS3/h;
...
.method private final e(Ljava/io/File;Z)V
    ...
    iget-object v0, p0, LO3/y;->d:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, p0, LO3/y;->c:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getAssets()Landroid/content/res/AssetManager;

    move-result-object v0

    iget-object v1, p0, LO3/y;->d:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, LO3/y;->f:Ljava/io/File;

    if-eqz v0, :cond_1

    new-instance v0, Ljava/io/FileInputStream;

    iget-object v1, p0, LO3/y;->f:Ljava/io/File;
    ...
    :cond_1
    iget-object v0, p0, LO3/y;->g:Ljava/util/concurrent/Callable;
    ...
    :goto_0
    iget-object v1, p0, LO3/y;->c:Landroid/content/Context;
    ...
    invoke-static {v0, v2}, LQ3/c;->a(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/channels/FileChannel;)V
    ...
    invoke-direct {p0, v1, p2}, LO3/y;->g(Ljava/io/File;Z)V
...
.method private final g(Ljava/io/File;Z)V
    ...
    iget-object p1, p0, LO3/y;->o:LO3/f;
...
.method private final i(Z)V
    ...
    invoke-virtual {p0}, LO3/y;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_6

    iget-object v2, p0, LO3/y;->c:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->getDatabasePath(Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    iget-object v3, p0, LO3/y;->o:LO3/f;
    ...
    :cond_0
    iget-boolean v3, v3, LO3/f;->s:Z

    new-instance v6, LU3/a;

    iget-object v7, p0, LO3/y;->c:Landroid/content/Context;
    ...
    invoke-direct {p0, v2, p1}, LO3/y;->e(Ljava/io/File;Z)V
    :try_end_1
    ...
    invoke-static {v2}, LQ3/b;->c(Ljava/io/File;)I
    ...
    :cond_2
    :try_start_5
    iget-object v8, p0, LO3/y;->o:LO3/f;
    ...
    invoke-virtual {v5, v3, v4}, LO3/f;->a(II)Z
    ...
    :cond_4
    :try_start_6
    iget-object v3, p0, LO3/y;->c:Landroid/content/Context;
...
.method public c()LS3/h;
    ...
    iget-object v0, p0, LO3/y;->j:LS3/h;
...
.method public declared-synchronized close()V
    ...
    :try_start_0
    invoke-virtual {p0}, LO3/y;->c()LS3/h;
...
.method public final h(LO3/f;)V
    ...
    iput-object p1, p0, LO3/y;->o:LO3/f;
...
.method public o0()LS3/g;
    ...
    iget-boolean v0, p0, LO3/y;->p:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    invoke-direct {p0, v0}, LO3/y;->i(Z)V
