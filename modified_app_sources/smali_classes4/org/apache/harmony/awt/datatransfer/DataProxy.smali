...
.method private createBufferedImage(Lorg/apache/harmony/awt/datatransfer/RawBitmap;)Ljava/awt/image/BufferedImage;
    ...
    invoke-direct {v3, v6, v4, v7, v8}, Ljava/awt/image/DirectColorModel;-><init>(IIII)V

    new-instance v7, Ljava/awt/image/DataBufferInt;

    array-length v4, v2

    invoke-direct {v7, v2, v4}, Ljava/awt/image/DataBufferInt;-><init>([II)V

    iget v8, v0, Lorg/apache/harmony/awt/datatransfer/RawBitmap;->width:I

    iget v9, v0, Lorg/apache/harmony/awt/datatransfer/RawBitmap;->height:I

    iget v10, v0, Lorg/apache/harmony/awt/datatransfer/RawBitmap;->stride:I

    const/4 v12, 0x0

    invoke-static/range {v7 .. v12}, Ljava/awt/image/Raster;->createPackedRaster(Ljava/awt/image/DataBuffer;III[ILjava/awt/Point;)Ljava/awt/image/WritableRaster;
    ...
    invoke-direct {v9, v2, v3}, Ljava/awt/image/DataBufferByte;-><init>([BI)V
    ...
    iget v6, v0, Lorg/apache/harmony/awt/datatransfer/RawBitmap;->bMask:I
    ...
    new-instance v7, Ljava/awt/image/DataBufferUShort;

    array-length v4, v2

    invoke-direct {v7, v2, v4}, Ljava/awt/image/DataBufferUShort;-><init>([SI)V
