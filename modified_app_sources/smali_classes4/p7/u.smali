...
.method public c(Lp7/B;Lp7/B;)V
    ...
    :try_start_0
    invoke-virtual {p1}, Lp7/B;->l()Ljava/nio/file/Path;

    move-result-object p1

    invoke-virtual {p2}, Lp7/B;->l()Ljava/nio/file/Path;
...
.method public m(Lp7/B;)Lp7/j;
    ...
    invoke-virtual {p0, p1}, Lp7/u;->u(Ljava/nio/file/Path;)Lp7/j;
...
.method protected final u(Ljava/nio/file/Path;)Lp7/j;
    .locals 13
    ...
    sget-object v5, Lp7/B;->d:Lp7/B$a;

    const/4 v6, 0x0

    const/4 v7, 0x1

    invoke-static {v5, p1, v6, v7, v0}, Lp7/B$a;->f(Lp7/B$a;Ljava/nio/file/Path;ZILjava/lang/Object;)Lp7/B;
    ...
    invoke-direct {p0, p1}, Lp7/u;->v(Ljava/nio/file/attribute/FileTime;)Ljava/lang/Long;
