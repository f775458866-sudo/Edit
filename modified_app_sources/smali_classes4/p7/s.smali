...
.method public constructor <init>(ZLjava/io/RandomAccessFile;)V
    ...
    invoke-direct {p0, p1}, Lp7/i;-><init>(Z)V

    iput-object p2, p0, Lp7/s;->i:Ljava/io/RandomAccessFile;
...
.method protected declared-synchronized k()V
    ...
    :try_start_0
    iget-object v0, p0, Lp7/s;->i:Ljava/io/RandomAccessFile;
...
.method protected declared-synchronized m(J[BII)I
    ...
    iget-object p2, p0, Lp7/s;->i:Ljava/io/RandomAccessFile;
