...
# direct methods
.method public constructor <init>(Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCaseParams;Lx6/l;Lx6/l;Lx6/l;Lx6/p;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->onReceive:Lx6/l;

    iput-object p3, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->onError:Lx6/l;

    iput-object p4, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->withConnectedClient:Lx6/l;

    return-void
.end method

.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;Ljava/lang/String;Ljava/util/Date;Lcom/android/billingclient/api/t;Lcom/android/billingclient/api/j;Ljava/util/List;)V
    .locals 0

    invoke-static/range {p0 .. p6}, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->queryProductDetailsAsyncEnsuringOneResponse$lambda$3(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;Ljava/lang/String;Ljava/util/Date;Lcom/android/billingclient/api/t;Lcom/android/billingclient/api/j;Ljava/util/List;)V
...
.method public static final synthetic access$queryProductDetailsAsyncEnsuringOneResponse(Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;Lcom/android/billingclient/api/d;Ljava/lang/String;Lcom/android/billingclient/api/x;Lcom/android/billingclient/api/t;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->queryProductDetailsAsyncEnsuringOneResponse(Lcom/android/billingclient/api/d;Ljava/lang/String;Lcom/android/billingclient/api/x;Lcom/android/billingclient/api/t;)V

    return-void
.end method

.method private final declared-synchronized queryProductDetailsAsyncEnsuringOneResponse(Lcom/android/billingclient/api/d;Ljava/lang/String;Lcom/android/billingclient/api/x;Lcom/android/billingclient/api/t;)V
    .locals 6
    ...
    new-instance v0, Lcom/revenuecat/purchases/google/usecase/d;
    :try_end_0
    ...
    :try_start_1
    invoke-direct/range {v0 .. v5}, Lcom/revenuecat/purchases/google/usecase/d;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;Ljava/lang/String;Ljava/util/Date;Lcom/android/billingclient/api/t;)V

    invoke-virtual {p1, p3, v0}, Lcom/android/billingclient/api/d;->i(Lcom/android/billingclient/api/x;Lcom/android/billingclient/api/t;)V
    :try_end_1
...
.method private static final queryProductDetailsAsyncEnsuringOneResponse$lambda$3(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;Ljava/lang/String;Ljava/util/Date;Lcom/android/billingclient/api/t;Lcom/android/billingclient/api/j;Ljava/util/List;)V
    ...
    :cond_0
    invoke-direct {p1, p2, p5, p3}, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->trackGoogleQueryProductDetailsRequestIfNeeded(Ljava/lang/String;Lcom/android/billingclient/api/j;Ljava/util/Date;)V

    invoke-interface {p4, p5, p6}, Lcom/android/billingclient/api/t;->a(Lcom/android/billingclient/api/j;Ljava/util/List;)V

    return-void
.end method

.method private final trackGoogleQueryProductDetailsRequestIfNeeded(Ljava/lang/String;Lcom/android/billingclient/api/j;Ljava/util/Date;)V
    .locals 7
...
.method public executeAsync()V
    ...
    iget-object v0, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->onReceive:Lx6/l;
    ...
    :cond_2
    iget-object v1, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->withConnectedClient:Lx6/l;
...
.method public final getOnError()Lx6/l;
    ...
    iget-object v0, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->onError:Lx6/l;
...
.method public final getWithConnectedClient()Lx6/l;
    ...
    iget-object v0, p0, Lcom/revenuecat/purchases/google/usecase/QueryProductDetailsUseCase;->withConnectedClient:Lx6/l;
...
.method public onOk(Ljava/util/List;)V
    ...
    invoke-static/range {v4 .. v12}, Ll6/q;->h0(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lx6/l;ILjava/lang/Object;)Ljava/lang/String;
