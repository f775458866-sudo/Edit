...
.method public static synthetic a(Lcom/android/billingclient/api/j;Ljava/util/List;)V
    ...
    invoke-static {p0, p1}, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion;->canMakePayments$lambda$0(Lcom/android/billingclient/api/j;Ljava/util/List;)V
...
.method private static final canMakePayments$lambda$0(Lcom/android/billingclient/api/j;Ljava/util/List;)V
    .locals 0
...
.method public final canMakePayments(Landroid/content/Context;Ljava/util/List;Lcom/revenuecat/purchases/interfaces/Callback;)V
    ...
    invoke-virtual {v0}, Lcom/android/billingclient/api/d$b;->b()Lcom/android/billingclient/api/d$b;
    ...
    invoke-virtual {v0, v1}, Lcom/android/billingclient/api/d$b;->d(Lcom/android/billingclient/api/w;)Lcom/android/billingclient/api/d$b;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/billingclient/api/d$b;->a()Lcom/android/billingclient/api/d;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion$canMakePayments$2$1;-><init>(Landroid/os/Handler;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/interfaces/Callback;Lcom/android/billingclient/api/d;Ljava/util/List;)V

    invoke-virtual {v5, v1}, Lcom/android/billingclient/api/d;->m(Lcom/android/billingclient/api/f;)V
