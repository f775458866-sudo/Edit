...
.method public enqueue(Ljava/lang/Runnable;Lcom/revenuecat/purchases/common/Delay;)V
    ...
    invoke-static {v2, v3}, LH6/a;->n(J)J
    ...
    invoke-static {v4, v5}, LH6/a;->n(J)J

    move-result-wide v4

    invoke-direct {p1, v2, v3, v4, v5}, LD6/i;-><init>(JJ)V

    sget-object p2, LB6/c;->c:LB6/c$a;

    invoke-static {p1, p2}, LD6/j;->q(LD6/i;LB6/c;)J
