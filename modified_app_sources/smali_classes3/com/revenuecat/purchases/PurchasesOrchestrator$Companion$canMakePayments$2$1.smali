...
# instance fields
.field final synthetic $billingClient:Lcom/android/billingclient/api/d;
...
# direct methods
.method constructor <init>(Landroid/os/Handler;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/interfaces/Callback;Lcom/android/billingclient/api/d;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion$canMakePayments$2$1;->$billingClient:Lcom/android/billingclient/api/d;
...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/android/billingclient/api/j;Lcom/revenuecat/purchases/interfaces/Callback;Lcom/android/billingclient/api/d;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion$canMakePayments$2$1;->onBillingSetupFinished$lambda$1(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/android/billingclient/api/j;Lcom/revenuecat/purchases/interfaces/Callback;Lcom/android/billingclient/api/d;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic b(Lcom/android/billingclient/api/d;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/interfaces/Callback;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion$canMakePayments$2$1;->onBillingServiceDisconnected$lambda$2(Lcom/android/billingclient/api/d;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/interfaces/Callback;)V

    return-void
.end method

.method private static final onBillingServiceDisconnected$lambda$2(Lcom/android/billingclient/api/d;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/interfaces/Callback;)V
    .locals 4
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/android/billingclient/api/d;->c()V
    :try_end_0
...
.method private static final onBillingSetupFinished$lambda$1(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/android/billingclient/api/j;Lcom/revenuecat/purchases/interfaces/Callback;Lcom/android/billingclient/api/d;Ljava/util/List;)V
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, Lcom/revenuecat/purchases/google/BillingResultExtensionsKt;->isSuccessful(Lcom/android/billingclient/api/j;)Z
    ...
    invoke-virtual {p3}, Lcom/android/billingclient/api/d;->c()V
    ...
    invoke-virtual {p3, p1}, Lcom/android/billingclient/api/d;->e(Ljava/lang/String;)Lcom/android/billingclient/api/j;
...
.method public onBillingServiceDisconnected()V
    ...
    iget-object v1, p0, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion$canMakePayments$2$1;->$billingClient:Lcom/android/billingclient/api/d;
    ...
    invoke-direct {v4, v1, v2, v3}, Lcom/revenuecat/purchases/h;-><init>(Lcom/android/billingclient/api/d;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/revenuecat/purchases/interfaces/Callback;)V
...
.method public onBillingSetupFinished(Lcom/android/billingclient/api/j;)V
    ...
    iget-object v5, p0, Lcom/revenuecat/purchases/PurchasesOrchestrator$Companion$canMakePayments$2$1;->$billingClient:Lcom/android/billingclient/api/d;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/revenuecat/purchases/i;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/android/billingclient/api/j;Lcom/revenuecat/purchases/interfaces/Callback;Lcom/android/billingclient/api/d;Ljava/util/List;)V
