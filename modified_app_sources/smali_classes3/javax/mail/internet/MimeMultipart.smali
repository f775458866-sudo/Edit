...
.method private declared-synchronized parsebm()V
    ...
    invoke-interface {v0, v3, v4, v7, v8}, Ljavax/mail/internet/SharedInputStream;->newStream(JJ)Ljava/io/InputStream;

    move-result-object v5

    invoke-virtual {v1, v5}, Ljavax/mail/internet/MimeMultipart;->createMimeBodyPart(Ljava/io/InputStream;)Ljavax/mail/internet/MimeBodyPart;
    ...
    invoke-virtual {v5, v10, v0, v13}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    :goto_17
    iget-boolean v0, v1, Ljavax/mail/internet/MimeMultipart;->complete:Z
    ...
    invoke-virtual {v5, v9, v0, v11}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    invoke-virtual {v1, v15, v0}, Ljavax/mail/internet/MimeMultipart;->createMimeBodyPart(Ljavax/mail/internet/InternetHeaders;[B)Ljavax/mail/internet/MimeBodyPart;

    move-result-object v5

    :goto_18
    invoke-super {v1, v5}, Ljavax/mail/Multipart;->addBodyPart(Ljavax/mail/BodyPart;)V
    ...
    invoke-virtual {v0, v10, v7, v5}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    invoke-virtual {v0, v10, v8, v13}, Ljava/io/ByteArrayOutputStream;->write([BII)V
...
.method protected declared-synchronized parse()V
    ...
    invoke-direct {v1}, Ljavax/mail/internet/MimeMultipart;->parsebm()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
